...
bool FetchUtils::IsSecurityOriginWhitelisted(
    const String& origin) {
  const Vector<String> whitelisted_domains({
// QA and internal facing servers, to be removed in production
          "http://127.0.0.1:7768",
          "https://silverbullet-ats.itunes.apple.com",
          "https://silverbullet-ats-nk11.itunes.apple.com",
          "https://silverbullet-ats-st11.itunes.apple.com",
          "https://silverbullet-ats-mr22.itunes.apple.com",
          "https://silverbullet-pv33.itunes.apple.com",
          "https://silverbullet-ats-itms11.itunes.apple.com",
          "https://silverbullet-ats-itms8.itunes.apple.com",
          "https://silverbullet-ats-itms7.itunes.apple.com",
          "https://silverbullet-ats-itms6.itunes.apple.com",
          "https://silverbullet-ats-itms5.itunes.apple.com",
// External facing production servers
          "https://silverbullet-external-ats.itunes.apple.com",
          "https://silverbullet-external-ats-nk11.itunes.apple.com",
          "https://silverbullet-external-ats-st11.itunes.apple.com",
          "https://silverbullet-external-ats-mr22.itunes.apple.com",
          "https://mediaservices.cdn-apple.com",
          "https://mediaservices.apple.com",
  });
  ...
  return whitelisted_domains.Contains(origin.LowerASCII());
}

bool FetchUtils::IsSecurityOriginAndContentTypeWhitelisted(
    const String& origin,
    const String& type) {
  const Vector<String> whitelisted_types({
          "application/json",
  ...
  if(origin.length() == 0 || type.length() == 0) {
    return false;
  }

  bool originIsWhitelisted = FetchUtils::IsSecurityOriginWhitelisted(origin);

  bool typeIsWhitelisted = whitelisted_types.Contains(type.LowerASCII()) ||
                           type.StartsWith("video/", kTextCaseASCIIInsensitive) ||
                           type.StartsWith("audio/", kTextCaseASCIIInsensitive) ||
                           type.StartsWith("image/", kTextCaseASCIIInsensitive);

  return originIsWhitelisted && typeIsWhitelisted;
}
