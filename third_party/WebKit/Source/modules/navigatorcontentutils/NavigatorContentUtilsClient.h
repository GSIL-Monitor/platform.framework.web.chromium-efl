...
class MODULES_EXPORT NavigatorContentUtilsClient
 ...
 public:
  ...
  virtual void RegisterProtocolHandler(const String& scheme,
                                       const KURL&,
                                       const String& title);
    virtual void registerContentHandler(const String& mimeType, const KURL& baseURL, const KURL&, const String& title);
  ...
  virtual CustomHandlersState IsProtocolHandlerRegistered(const String& scheme,
                                                          const KURL&);
  virtual CustomHandlersState isContentHandlerRegistered(const String& mimeType, const KURL& baseURL, const KURL&);
  virtual void unregisterContentHandler(const String& mimeType, const KURL& baseURL, const KURL&);
