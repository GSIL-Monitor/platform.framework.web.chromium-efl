...
class CORE_EXPORT RuleSet : public GarbageCollectedFinalized<RuleSet> {
 ...
 public:
  ...
  void SetContentBlockerRules(bool is_content_blocker_rules);
  ...
  bool IsContentBlockerRules() const { return is_content_blocker_rules_; }
 ...
 private:
  ...
  RuleSet() : rule_count_(0), is_content_blocker_rules_(false) {}
  ...
  bool is_content_blocker_rules_;
