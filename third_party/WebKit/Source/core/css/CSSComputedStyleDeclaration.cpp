...
const CSSPropertyID kComputedPropertyArray[] = {
    ...
    CSSPropertyNavDown, CSSPropertyNavLeft, CSSPropertyNavRight,
    CSSPropertyNavUp, CSSPropertyObjectFit, CSSPropertyObjectPosition,
    CSSPropertyOffsetAnchor, CSSPropertyOffsetDistance, CSSPropertyOffsetPath,
    CSSPropertyOffsetPosition, CSSPropertyOffsetRotate, CSSPropertyOpacity,
