...
class CORE_EXPORT Element : public ContainerNode {
 ...
 public:
  ...
  bool IsMatchedByContentBlocker() const;
  void SetIsMatchedByContentBlocker(const bool);
  bool WasCountedByContentBlocker() const;
  void SetWasCountedByContentBlocker(const bool);
...
inline bool Element::IsMatchedByContentBlocker() const {
  return GetElementData() && GetElementData()->IsMatchedByContentBlocker();
}

inline void Element::SetIsMatchedByContentBlocker(const bool matched) {
  if (!GetElementData() && !matched)
    return;
  EnsureUniqueElementData().SetIsMatchedByContentBlocker(matched);
}

inline bool Element::WasCountedByContentBlocker() const {
  return GetElementData() && GetElementData()->WasCountedByContentBlocker();
}

inline void Element::SetWasCountedByContentBlocker(const bool counted) {
  if (!GetElementData() && !counted)
    return;
  EnsureUniqueElementData().SetWasCountedByContentBlocker(counted);
}
