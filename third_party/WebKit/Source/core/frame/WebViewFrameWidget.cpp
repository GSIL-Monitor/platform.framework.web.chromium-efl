...
int WebViewFrameWidget::GetAdvancedIMEOptions() {
// FIXME: Commented the code during dev/m60_3112 rebaseline.
// It needs a revisit by Author.
#if 0
  return web_view_->GetAdvancedIMEOptions();
#endif
  return 0;
}
...
bool WebViewFrameWidget::IsHitScrollbar() {
  return web_view_->IsHitScrollbar();
}

bool WebViewFrameWidget::IsMouseDownEventSwallowed() {
  return web_view_->IsMouseDownEventSwallowed();
}
