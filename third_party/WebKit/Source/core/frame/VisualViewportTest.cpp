...
TEST_P(VisualViewportTest, TestBrowserControlsAdjustmentAndResize) {
  ...
  WebView()->ResizeWithBrowserControls(
      WebSize(500, visual_viewport_height - browser_controls_height - bottomControlsHeight), 20, 0,
      true);
...
TEST_P(VisualViewportTest, TestBrowserControlsShrinkAdjustmentAndResize) {
  ...
  EXPECT_EQ(IntSize(250, (visual_viewport_height - browser_controls_height - bottomControlsHeight) /
                             page_scale),
            visual_viewport.VisibleRect().Size());

  ScrollOffset frame_view_expected(
      0, content_height - (layout_viewport_height -
                           browser_controls_height  + bottomControlsHeight / min_page_scale));
  ScrollOffset visual_viewport_expected = ScrollOffset(
      750, (layout_viewport_height - browser_controls_height + bottomControlsHeight / min_page_scale -
            visual_viewport.VisibleRect().Height()));
  ...
  EXPECT_EQ(IntSize(500, visual_viewport_height - browser_controls_height  - bottomControlsHeight),
            visual_viewport.Size());
  EXPECT_EQ(IntSize(250, (visual_viewport_height - browser_controls_height  - bottomControlsHeight) /
                             page_scale),
            visual_viewport.VisibleRect().Size());
