...
class CORE_EXPORT Page final : public GarbageCollectedFinalized<Page>,
 ...
 public:
...
#if defined(USE_EFL)
  blink::ViewMode GetViewMode() const { return view_mode_; }
  void SetViewMode(blink::ViewMode mode);
#endif
  ...
  bool hasOverviewModeChanged() const { return m_hasOverviewModeChanged; }
  void setHasOverviewModeChanged(bool hasOverviewModeChanged) { m_hasOverviewModeChanged = hasOverviewModeChanged; }
  ...
  bool IsFloatingPage() const { return is_floating_page_; }
  void NotifyViewResumedByTabSwitching(bool enable) {
    is_view_resumed_by_tab_switching_ = enable;
  }
  bool IsViewResumedByTabSwitching() const {
    return is_view_resumed_by_tab_switching_;
  }
#endif
 ...
 private:
  ...
  bool m_hasOverviewModeChanged;
#if defined(USE_EFL)
  unsigned long long_polling_global_timeout_;
  bool defers_loading_;
#endif


#if defined(OS_TIZEN_TV_PRODUCT)
  bool is_floating_page_;
  bool is_view_resumed_by_tab_switching_;
#endif
