...
#if defined(OS_TIZEN)
  Timer<XMLHttpRequest> async_start_timer_;
  ResourceRequest async_request_;
  ThreadableLoaderOptions async_options_;
  ResourceLoaderOptions async_resource_loader_options_;
#endif
};
