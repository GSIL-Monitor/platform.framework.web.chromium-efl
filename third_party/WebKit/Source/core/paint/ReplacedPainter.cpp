...
#if !defined(USE_EFL)
  // Android avoids drawing selection over replaced elements, but not Tizen.
  // FIXME: Pair up both UX requirements.
  // http://web.sec.samsung.net/bugzilla/show_bug.cgi?id=15237

  draw_selection_tint = false;
#endif
