...
void InlineTextBoxPainter::PaintSelection(GraphicsContext& context,
  ...
  // Samsung specific UX behavior : does not paint line gaps.
  if (LIKELY(!LayoutTestSupport::IsRunningLayoutTest()))
    selection_top = std::max(selection_top, inline_text_box_.LogicalTop());
