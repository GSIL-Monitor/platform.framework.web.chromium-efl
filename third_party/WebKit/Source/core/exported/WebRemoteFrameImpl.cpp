...
void WebRemoteFrameImpl::clearTextSelection()
{
    NOTREACHED();
}
...
void WebRemoteFrameImpl::selectLinkText()
{
  NOTREACHED();
}

bool WebRemoteFrameImpl::recognizeArticle(ReaderMode readerMode, WebString& pageURL)
{
    NOTREACHED();
    return false;
}
