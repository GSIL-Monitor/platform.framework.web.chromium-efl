...
class utc_blink_ewk_settings_uses_arrow_scroll_get : public utc_blink_ewk_base {
 protected:
 ...
 */
TEST_F(utc_blink_ewk_settings_uses_arrow_scroll_get, POS_TEST_EINA_TRUE) {
 ...
 * @brief Tests if sets correctly, when called with correct WebSettings object
 */
TEST_F(utc_blink_ewk_settings_uses_arrow_scroll_get, POS_TEST_EINA_FALSE) {
 ...
 */
TEST_F(utc_blink_ewk_settings_uses_arrow_scroll_get, NEG_TEST) {
  EXPECT_FALSE(ewk_settings_uses_arrow_scroll_get(NULL));
}
