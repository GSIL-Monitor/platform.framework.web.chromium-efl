...
protected:
  ...
  ~utc_blink_ewk_context_application_cache_delete() override {
    SetOrigins(NULL);
  }
...
const char* const utc_blink_ewk_context_application_cache_delete::appCacheURL = SAMPLE_ORIGIN_PROTOCOL "://" SAMPLE_ORIGIN_HOST "/demo/";
