...
protected:
  ...
  ~utc_blink_ewk_view_add_in_incognito_mode() override {
...
const char* const utc_blink_ewk_view_add_in_incognito_mode::appCacheURL =
    SAMPLE_ORIGIN_PROTOCOL "://" SAMPLE_ORIGIN_HOST "/demo/";
