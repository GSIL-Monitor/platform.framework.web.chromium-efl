...
class utc_blink_ewk_autofill_credit_card_data_set : public utc_blink_ewk_base {
 protected:
  utc_blink_ewk_autofill_credit_card_data_set() {
    m_card = ewk_autofill_credit_card_new();
  }

  ~utc_blink_ewk_autofill_credit_card_data_set() override {
...
TEST_F(utc_blink_ewk_autofill_credit_card_data_set, POS_TEST) {
  ASSERT_TRUE(m_card);
  const std::string m_cardName("MyCreditCard");
