...
class utc_blink_ewk_context_application_type_set : public utc_blink_ewk_base {};

/**
 * @brief Checking whether application type is returned to
 * EWK_APPLICATION_TYPE_WEBBROWSER.
 */
TEST_F(utc_blink_ewk_context_application_type_set, POS_TEST1) {
 ...
 */
TEST_F(utc_blink_ewk_context_application_type_set, POS_TEST2) {
 ...
 */
TEST_F(utc_blink_ewk_context_application_type_set, POS_TEST3) {
