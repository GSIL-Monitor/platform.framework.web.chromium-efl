...
#ifndef TIZEN_SRC_EWK_EFL_INTEGRATION_URL_INFO_H_
#define TIZEN_SRC_EWK_EFL_INTEGRATION_URL_INFO_H_
...
class UrlInfo {
 public:
  ...
  bool HasUrl(const GURL& url) const { return url_ == url; }
...
#endif  // TIZEN_SRC_EWK_EFL_INTEGRATION_URL_INFO_H_
