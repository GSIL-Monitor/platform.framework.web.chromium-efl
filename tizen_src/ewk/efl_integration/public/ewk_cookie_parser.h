 ...
 *
 * @details The application can use this function use the internal Cookie parsing
 *          code to decode cookie strings. This allows the calling application to
 *          manage non-standard cookies without effecting the security policies
 *          that have been set up in Chromium. These can be used for non-standard
 *          schemes the may want to use cookies.
 *
 ...
 *
 *          NOTE: if the cookie has an expiry_date == 0 then the cookie should be
 *                treated as a session cookie.
 *
 * @since_tizen 4.0
 *
