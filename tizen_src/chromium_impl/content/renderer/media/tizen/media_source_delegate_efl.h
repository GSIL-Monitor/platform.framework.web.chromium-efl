...
namespace media {
class StreamFramerate;
}
#endif

namespace content {

class MediaSourceDelegateEfl : public media::DemuxerHost {
 public:
...
#if defined(OS_TIZEN_TV_PRODUCT)
  media::RelevantSeekValues GetRelevantSeekValues(
 ...
 private:
  ...
  void OnFramerateSet(const media::StreamFramerate::Framerate& framerate);
  void NotifyDemuxerStateChanged();
  bool IsFramerateChanged(const media::StreamFramerate::Framerate& framerate);
#endif
