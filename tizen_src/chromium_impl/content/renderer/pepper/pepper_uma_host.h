...
#ifndef CONTENT_RENDERER_PEPPER_PEPPER_UMA_HOST_H_
#define CONTENT_RENDERER_PEPPER_PEPPER_UMA_HOST_H_
...
class PepperUMAHost : public ppapi::host::ResourceHost {
 ...
 private:
  ...
  // Set of hashed histograms that can be used from this interface.
  std::set<std::string> allowed_histograms_;

  DISALLOW_COPY_AND_ASSIGN(PepperUMAHost);
};

#endif  // CONTENT_RENDERER_PEPPER_PEPPER_UMA_HOST_H_
