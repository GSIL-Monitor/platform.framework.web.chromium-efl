...
SHIM_TEMPLATE = """
/* Generates shim headers that mirror the directory structure of bundled
 * headers,but just forward to the system ones. This allows seamless compilation
 * against system headers with no changes to our source code.
 */
"""
