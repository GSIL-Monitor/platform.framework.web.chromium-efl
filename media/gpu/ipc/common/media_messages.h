...
IPC_MESSAGE_ROUTED4(AcceleratedVideoDecoderHostMsg_NotifyDecodeDone,
                    base::SharedMemoryHandle, /* Shared Memory Handle */
                    uint32_t,                 /* Bitstream buffer ID */
                    uint32_t,                 /* size */
                    gfx::Rect)                /* Frame Resolution */
#endif
