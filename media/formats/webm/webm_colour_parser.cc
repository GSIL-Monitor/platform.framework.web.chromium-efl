...
const std::string WebMColourParser::GetWebMHdrInfo() {
  std::ostringstream s;
  s << "matrixCoefficients:" << matrix_coefficients_
    << " bitsPerChannel:" << bits_per_channel_
    << " chromaSubsamplingHorz:" << chroma_subsampling_horz_
    << " chromaSubsamplingVert:" << chroma_subsampling_vert_
    << " cbSubsamplingHorz:" << cb_subsampling_horz_
    << " cbSubsamplingVert:" << cb_subsampling_vert_
    << " chromaSitingHorz:" << chroma_siting_horz_
    << " chromaSitingVert:" << chroma_siting_vert_ << " range:" << range_
    << " transferCharacteristics:" << transfer_characteristics_
    << " primaries:" << primaries_ << " maxCLL:" << max_content_light_level_
    << " maxFALL:" << max_content_light_level_
    << " RX:" << mastering_metadata_parser_.GetMasteringMetadata().primary_r.x()
    << " RY:" << mastering_metadata_parser_.GetMasteringMetadata().primary_r.y()
    << " GX:" << mastering_metadata_parser_.GetMasteringMetadata().primary_g.x()
    << " GY:" << mastering_metadata_parser_.GetMasteringMetadata().primary_g.y()
    << " BX:" << mastering_metadata_parser_.GetMasteringMetadata().primary_b.x()
    << " BY:" << mastering_metadata_parser_.GetMasteringMetadata().primary_b.y()
    << " wX:"
    << mastering_metadata_parser_.GetMasteringMetadata().white_point.x()
    << " wY:"
    << mastering_metadata_parser_.GetMasteringMetadata().white_point.y()
    << " luminanceMax:"
    << mastering_metadata_parser_.GetMasteringMetadata().luminance_max
    << " luminanceMin:"
    << mastering_metadata_parser_.GetMasteringMetadata().luminance_min;
