...
#if defined(TIZEN_TBM_SUPPORT) && defined(OS_TIZEN_TV_PRODUCT)
  void CreateTbmTextureIfNeeded(gpu::gles2::GLES2Interface*, unsigned);
  void SetStartedOESTexture(bool enabled);
  bool isStartedOESTexture() { return is_started_oes_frame_; }
#endif
