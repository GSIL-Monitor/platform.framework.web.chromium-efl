 ...
 public:
  ...
  class MEDIA_EXPORT Client {
   public:
    ...
    virtual void NotifyDecodeDone(
        base::SharedMemoryHandle shared_memory_handle,
        uint32_t bitstream_buffer_id,
        uint32_t buffer_size,
        gfx::Rect frame_size) = 0;
#endif
...
#if defined(TIZEN_RESOURCE_MANAGER)
  void SetResourceManager(content::TizenResourceManager* mgr);
#endif

 protected:
#if defined(TIZEN_RESOURCE_MANAGER)
  content::TizenResourceManager* resource_manager_{nullptr};
#endif
