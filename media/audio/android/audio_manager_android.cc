...
bool AudioManagerAndroid::IsAudioLowLatencyOutputFrameSizeSupported() {
  return Java_AudioManagerAndroid_isAudioLowLatencyOutputFrameSizeSupported(
      base::android::AttachCurrentThread(),
      j_audio_manager_);
}
...
int AudioManagerAndroid::GetOptimalOutputFrameSize(int sample_rate,
  ...
  if(IsAudioLowLatencyOutputFrameSizeSupported())
      return GetAudioLowLatencyOutputFrameSize();
