  ...
  static const base::flat_map<std::string, MimeUtil::Codec> kStringToCodecMap(
      {
        ...
        {"mp4v.20.8", MimeUtil::H264},
#endif
#if defined(OS_TIZEN_TV_PRODUCT) && !BUILDFLAG(ENABLE_DOLBY_VISION_DEMUXING)
        {"dvhe.dtr", MimeUtil::DOLBY_VISION},
#endif
...
#if BUILDFLAG(ENABLE_DOLBY_VISION_DEMUXING) || defined(OS_TIZEN_TV_PRODUCT)
...
#if !defined(TIZEN_MULTIMEDIA_SUPPORT) || defined(TIZEN_MULTIMEDIA_WEBM_SUPPORT)
...
#if BUILDFLAG(ENABLE_MSE_MPEG2TS_STREAM_PARSER) || defined(OS_TIZEN_TV_PRODUCT)
...
#endif
#endif  // defined(OS_ANDROID)
#if defined(TIZEN_MULTIMEDIA_SUPPORT) // Tizen supports HLS & m3u8.
  AddContainerWithCodecs("video/3gpp", mp4_codecs, true);
  AddContainerWithCodecs("application/vnd.apple.mpegurl", mp4_codecs, true);
  AddContainerWithCodecs("application/x-mpegURL", mp4_codecs, true);
  AddContainerWithCodecs("application/x-mpegurl", mp4_codecs, true);
  AddContainerWithCodecs("application/mpegurl", mp4_codecs, true);
  AddContainerWithCodecs("audio/mpegurl", mp4_audio_codecs, true);
  AddContainerWithCodecs("audio/x-mpegurl", mp4_audio_codecs, true);

  // Tizen supports DASH.
  if (IsTvProfile())
    AddContainerWithCodecs("application/dash+xml", mp4_codecs, true);

#if defined(OS_TIZEN_TV_PRODUCT)
  // support hbbtv CASD url
  AddContainerWithCodecs("application/vnd.oipf.contentaccessstreaming+xml",
                         mp4_codecs, true);
  AddContainerWithCodecs("video/mpeg", mp4_codecs, true);
#endif
#endif
