...
class MEDIA_EXPORT CdmContext {
 public:
  ...
  void SetPlayerType(MediaPlayerHostMsg_Initialize_Type player_type);
  MediaPlayerHostMsg_Initialize_Type GetPlayerType() const;
#endif
 ...
 private:
#if defined(OS_TIZEN_TV_PRODUCT)
  MediaPlayerHostMsg_Initialize_Type player_type_ = MEDIA_PLAYER_TYPE_NONE;
#endif
