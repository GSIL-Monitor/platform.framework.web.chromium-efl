...
class MEDIA_EXPORT MediaPlayerManager {
 public:
  ...
  // Called by listeners to request media playback.
  virtual void PlayMedia(int player_id) = 0;

  // Called by listeners to pause media playback.
  virtual void PauseMedia(int player_id) = 0;
#endif
};
