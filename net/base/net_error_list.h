...
// The request was blocked by ContentBlockers.
NET_ERROR(BLOCKED_BY_CONTENT_BLOCKER, -98)

// The request was blocked by Tracker Block.
NET_ERROR(BLOCKED_BY_TRACKER_BLOCK, -99)
