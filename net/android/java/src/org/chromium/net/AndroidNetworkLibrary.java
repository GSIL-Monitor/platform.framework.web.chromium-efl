...
public class AndroidNetworkLibrary {
    ...
    /**
     * This interface is used to send_cert_error_type_to_mdm
     */
    public interface CertificateErrorObserver {
        void notify(int type, boolean isExpired);
    }

    private static CertificateErrorObserver sCertificateErrorObserver = null;

    public static void setCertificateErrorObserver(CertificateErrorObserver ob) {
        sCertificateErrorObserver = ob;
    }

    /**
     * Report the error type of the validation of server certificate
     * @param error type of the validation of server certificate
     */
    @CalledByNative
    static void notifyCertificateError(int type, boolean isExpired) {
        if (sCertificateErrorObserver != null) {
            sCertificateErrorObserver.notify(type, isExpired);
        }
    }
