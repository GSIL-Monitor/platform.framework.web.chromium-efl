...
class STORAGE_EXPORT SpecialStoragePolicy
 ...
 public:
  typedef base::Callback<void(bool policy_changed)> QuotaExceededReplyCallback;
...
#if defined(OS_TIZEN)
  virtual bool RequestUnlimitedStoragePolicy(
      const GURL& origin,
      int64_t quota,
      const QuotaExceededReplyCallback& callback) = 0;
#endif
