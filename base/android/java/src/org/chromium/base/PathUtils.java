...
public abstract class PathUtils {
    ...
    @SuppressWarnings("unused")
    @CalledByNative
    private static String getNativeLocalLibraryDirectory() {
        return ContextUtils.getApplicationContext().getApplicationInfo().nativeLibraryDir;
    }

    /**
     * @return the path to apk path.
     */
    @SuppressWarnings("unused")
    @CalledByNative
    private static String getLibraryApkPath() {
