...
// UserAgent related
const char kCscFeatureUserAgent[] = "csc-feature-user-agent";

// CustomErrorPage related
const char kCscFeatureCustomErrorPage[] = "csc-feature-custom-error-page";
...
// SAMSUNG: Enables the SamsungDex mode which shows device screen to monitor.
const char kEnableSamsungDex[] = "enable-samsung-dex";
const char kSamsungDexEnabledValue[] = "1";

// Append commandline for checking GED devices.
const char kUseGEDFeature[] = "use-ged-feature";
