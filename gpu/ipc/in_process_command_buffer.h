...
// ImageTransportSurfaceDelegate implementation:
  ...
  CommandBufferService* command_buffer() { return command_buffer_.get(); }
  gles2::GLES2Decoder* decoder() { return decoder_.get(); }
 ...
 private:
#if defined(DIRECT_CANVAS)
  friend class DirectCanvasCommandBufferStub;
#endif
...
#if defined(DIRECT_CANVAS)
class GPU_EXPORT InProcessGpuService {
 public:
  static void SetGpuService(gpu::gles2::MailboxManager* mailbox_manager,
                            scoped_refptr<gl::GLShareGroup> share_group);
