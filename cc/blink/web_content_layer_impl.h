...
class WebDummyLayerImpl : public blink::WebContentLayer,
                          public cc::ContentLayerClient {
 public:
  CC_BLINK_EXPORT explicit WebDummyLayerImpl(blink::WebContentLayerClient*);

  ~WebDummyLayerImpl() override;
 ...
 private:
  DISALLOW_COPY_AND_ASSIGN(WebDummyLayerImpl);
};
#endif
}  // namespace cc_blink
