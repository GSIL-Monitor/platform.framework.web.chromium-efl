...
#if defined(OS_TIZEN)
void PictureLayerTilingSet::SetTileCoverAreaMultiplier(
    float cover_area_multiplier) {
  cover_area_multiplier_set_ = true;
  cover_area_multiplier_ = cover_area_multiplier;
}
#endif
...
#if defined(OS_TIZEN)
  if (cover_area_multiplier_set_)
    distance = distance * cover_area_multiplier_;
#endif
