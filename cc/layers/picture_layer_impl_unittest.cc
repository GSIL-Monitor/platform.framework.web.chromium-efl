...
TEST_F(PictureLayerImplTest, DISABLED_PinchGestureTilings) {
  gfx::Size layer_bounds(1300, 1900);
...
TEST_F(PictureLayerImplTest, SnappedTilingDuringZoom) {
  ...
  // We should use the low-res tiling as high-res, and not create a new tiling.
...
TEST_F(PictureLayerImplTest, DISABLED_FirstTilingDuringPinch) {
  SetupDefaultTrees(gfx::Size(10, 10));
...
TEST_F(PictureLayerImplTest, PinchingTooSmallWithContentsScale) {
  ...
  EXPECT_FLOAT_EQ(pending_layer()->MinimumContentsScale(),
                  pending_layer()->HighResTiling()->contents_scale_key());
  EXPECT_LE(pending_layer()->MinimumContentsScale(),
                  pending_layer()->HighResTiling()->contents_scale_key());
}
...
TEST_F(NoLowResPictureLayerImplTest, DISABLED_LowResWasHighResCollision) {
  gfx::Size layer_bounds(1300, 1900);
