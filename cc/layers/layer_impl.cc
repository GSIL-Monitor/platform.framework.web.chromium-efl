...
LayerImpl::LayerImpl(LayerTreeImpl* tree_impl, int id)
    : layer_id_(id),
      ...
      scroll_corner_layer_id_(Layer::INVALID_ID),
#endif
      debug_info_(nullptr),
...
#if defined(TIZEN_VD_NATIVE_SCROLLBARS)
  layer->SetScrollCornerLayerId(scroll_corner_layer_id_);
#endif
...
#if defined(TIZEN_VD_NATIVE_SCROLLBARS)
void LayerImpl::SetScrollCornerLayerId(int scroll_corner_layer_id) {
  if (scroll_corner_layer_id_ == scroll_corner_layer_id)
    return;

  scroll_corner_layer_id_ = scroll_corner_layer_id;
  layer_tree_impl()->SetScrollbarGeometriesNeedUpdate();
}
#endif
}  // namespace cc
