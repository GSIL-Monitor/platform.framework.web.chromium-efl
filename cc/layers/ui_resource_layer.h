...
class CC_EXPORT UIResourceLayer : public Layer {
 public:
  ...
  // If you don't call DeleteUIResource() before call SetBitmap(),
  // It maybe occurred mem-leak.
  // If you get mem-leak using SetBitmap(), please call DeleteUIResource()
  // before call SetBitmap().
  ...
  // SAMSUNG CHANGE : It delete previous UIResourceId.
  void DeleteUIResource();
