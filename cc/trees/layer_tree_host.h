...
class CC_EXPORT LayerTreeHost : public viz::SurfaceReferenceOwner,
 ...
 public:
  ...
  void SetFastScrollerEnabled(bool enabled);
#endif
...
#if defined(OS_TIZEN)
  virtual void DidChangeLoadState(bool);
  virtual void SetTileCoverAreaMultiplier(float cover_area_multiplier) {}
  virtual void SetClearTilesOnHide(bool enable) {}
#endif
 ...
 private:
  ...
  bool layer_invert_failed_ = false;
#endif
...
#if defined(S_TERRACE_SUPPORT)
  bool fast_scroller_enabled_ = false;
#endif
