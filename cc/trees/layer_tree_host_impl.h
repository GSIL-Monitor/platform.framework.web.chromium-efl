...
#if defined(OS_TIZEN)
  virtual void SetTileCoverAreaMultiplier(float cover_area_multiplier);
#endif
...
#if defined(S_TERRACE_SUPPORT)
  void NotifyScrollbarState(bool requestToDisable);
  void CheckBigSubScrollingLayer(LayerImpl* scroll_layer,
      InputHandler::ScrollInputType type);
  bool GetBigSubScrollingLayerExists() { return big_sub_scrolling_layer_; }
#endif
...
#if defined(S_TERRACE_SUPPORT)
  bool big_sub_scrolling_layer_;
  bool fast_scroll_disabled_by_wheel_;
  bool target_viewport_scrolling_;
#endif
