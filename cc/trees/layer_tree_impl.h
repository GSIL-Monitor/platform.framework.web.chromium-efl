...
class CC_EXPORT LayerTreeImpl {
 public:
  ...
  void RegisterSelection(const LayerSelection& selection,
                         const gfx::Rect& selection_rect = gfx::Rect());
  ...
  void GetSelectionRect(gfx::Rect* rect);
  ...
  void set_fast_scroller_enabled(bool fast_scroller_enabled);
  bool get_fast_scroller_enabled() {
    return fast_scroller_enabled_;
  }
  bool CheckBigSubScrollingLayer() {
    return host_impl_->GetBigSubScrollingLayerExists();
  }
#endif
  ...
  void UpdateScrollbarAnimationIfNeeded(ElementId);
#endif
