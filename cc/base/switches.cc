...
// Enable direct canvas feature.
const char kEnableDirectCanvas[] = "enable-direct-canvas";
...
// Enables HideUrlBar Feature using UI Compositor for Bitmap Composition.
const char kEnableTopControlsUiComposition[] =
    "enable-top-controls-ui-composition";
