...
CC_BASE_EXPORT extern const char kDisable4444Textures[];
CC_BASE_EXPORT extern const char kEnableTopControlsUiComposition[];

// Switches for both the renderer and ui compositors.
CC_BASE_EXPORT extern const char kEnableDirectCanvas[];
