...
#if defined(USE_EFL)
STATIC_ASSERT_ENUM(blink::WebViewModeInvalid, blink::ViewModeInvalid);
STATIC_ASSERT_ENUM(blink::WebViewModeWindowed, blink::ViewModeWindowed);
STATIC_ASSERT_ENUM(blink::WebViewModeFullscreen, blink::ViewModeFullscreen);
#endif
