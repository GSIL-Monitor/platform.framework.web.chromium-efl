...
void SetRuntimeFeaturesDefaultsAndUpdateFromArgs(
  ...
  if (command_line.HasSwitch(switches::kUseSamsungMediaControls)) {
    WebRuntimeFeatures::enableUseSamsungMediaControls(true);
  }
