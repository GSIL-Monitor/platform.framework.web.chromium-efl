...
#endif
#if defined(USE_EFL)
  virtual bool GetWrtParsedUrl(const GURL& url, GURL& parsed_url);
#endif

#if defined(OS_TIZEN_TV_PRODUCT)
  // Notifies that a scrollbar's thumb part focus changed
  virtual void ScrollbarThumbPartFocusChanged(
      int view_id,
      blink::WebScrollbar::Orientation orientation,
      bool focused) {}

  virtual void RunArrowScroll(int view_id) {}
  virtual bool FloatingVideoWindowOn() const { return false; }
#endif
