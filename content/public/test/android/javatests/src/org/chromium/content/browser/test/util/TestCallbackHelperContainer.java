...
public class TestCallbackHelperContainer {
    ...
    public static class OnEvaluateJavaScriptResultHelper extends CallbackHelper {
        ...
        public void evaluateJavaScriptForTests(WebContents webContents, String code) {
            ...
            // To avoid test failure on S5 L OS
            try {
                webContents.getClass()
                        .getDeclaredMethod("evaluateJavaScriptForTests",
                                           String.class,
                                           JavaScriptCallback.class)
                                .invoke(webContents, code, callback);
            } catch (Exception e) {
                e.printStackTrace();
            } finally {
                mJsonResult = null;
