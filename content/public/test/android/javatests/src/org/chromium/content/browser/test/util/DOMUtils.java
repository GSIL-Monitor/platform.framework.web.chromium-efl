...
public class DOMUtils {
    ...
    /**
     * Returns the offset for selection of a node specified by its id.
     */
    public static int getSelectionOffset(final WebContents webContents, String nodeId)
            throws InterruptedException, TimeoutException {
        StringBuilder sb = new StringBuilder();
        sb.append("(function() {");
        sb.append("  var node = document.getElementById('" + nodeId + "');");
        sb.append("  if (!node) return null;");
        sb.append("  return node.selectionStart");
        sb.append("})();");
