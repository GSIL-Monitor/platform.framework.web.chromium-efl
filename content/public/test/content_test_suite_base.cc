...
base::LazyInstance<content::TestTerraceContentBridge>::Leaky
    g_test_terrace_content_bridge = LAZY_INSTANCE_INITIALIZER;
...
#if defined(S_TERRACE_SUPPORT)
  TerraceContentBridge::SetInstance(g_test_terrace_content_bridge.Pointer());
#endif // S_TERRACE_SUPPORT
}
