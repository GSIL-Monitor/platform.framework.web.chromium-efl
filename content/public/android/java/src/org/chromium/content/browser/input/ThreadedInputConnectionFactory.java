...
public class ThreadedInputConnectionFactory implements ChromiumBaseInputConnection.Factory {
    ...
    protected ThreadedInputConnection mThreadedInputConnection;
    protected CheckInvalidator mCheckInvalidator;
    ...
    protected static class CheckInvalidator {
    ...
    protected ThreadedInputConnectionFactory(InputMethodManagerWrapper inputMethodManagerWrapper) {
    ...
    protected boolean shouldTriggerDelayedOnCreateInputConnection() {
    ...
    protected void triggerDelayedOnCreateInputConnection(final View view) {
