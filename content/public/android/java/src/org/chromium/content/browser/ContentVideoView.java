...
public class ContentVideoView extends FrameLayout
    ...
    protected final ContentVideoViewEmbedder mEmbedder;
     ...
     * If returns true, no rendering should happen inside the surface texture
     * after this method is invoked. If returns false, the client needs to call release().
    ...
    /**
     * VideoTextureView class is a wrapper of TextureView.
     */
    ...
    protected ContentVideoView(Context context, long nativeContentVideoView,
        ...
        mVideoTextureView = new VideoTextureView(context);
    ...
    public void showContentVideoView() {
        ...
        addView(mVideoTextureView, new FrameLayout.LayoutParams(
    ...
    protected void openVideo() {
        if (mSurface != null) {
            ...
            if (mNativeContentVideoView != 0) {
                ...
                nativeSetSurface(mNativeContentVideoView, mSurface);
            }
        }
    }
    ...
    protected void destroyContentVideoView(boolean nativeViewDestroyed) {
        if (mVideoTextureView != null) {
            ...
            // To prevent re-entrance, call this after removeTextureView.
    ...
    protected native void nativeDidExitFullscreen(
