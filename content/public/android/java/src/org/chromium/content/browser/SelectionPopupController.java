...
public class SelectionPopupController extends ActionModeCallbackHelper {
     ...
     */
    protected void hideActionMode(boolean hide) {
     ...
     */
    protected boolean isSelectionEditable() {
        return mEditable;
    }
    ...
    @CalledByNative
    protected void onSelectionEvent(int eventType, int left, int top, int right, int bottom) {
        ...
        switch (eventType) {
            ...
            case SelectionEventType.SELECTION_IN_PROGRESS:
            case SelectionEventType.SELECTION_AUTO_SCROLL_BEGIN:
            case SelectionEventType.SELECTION_TEXT_MAGNIFIER_SHOWN:
            case SelectionEventType.SELECTION_TEXT_MAGNIFIER_HIDDEN:
                break;
