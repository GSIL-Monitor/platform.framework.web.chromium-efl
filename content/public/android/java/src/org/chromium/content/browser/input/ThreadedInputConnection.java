...
public class ThreadedInputConnection
    ...
    protected ThreadedInputConnection(View view, ImeAdapter imeAdapter, Handler handler) {
        super(view, true);
     ...
     */
    public BlockingQueue<TextInputState> getQueueForTest() {
        return mQueue;
    }
    ...
    public boolean deleteSurroundingText(final int beforeLength, final int afterLength) {
        ...
        ThreadUtils.postOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                // Chromium does not support Zawgyi languge and thus characters are considered as
                // grapheme clusters and when a transformation is about to happen,
                // deleteSurroundingText() is called which in turns deletes an extra character
                // instead of deleting only one character. Hence, we need to issue a normal
                // deletion call in case of Zawgyi
