...
public class SelectPopupDropdown implements SelectPopup {
    ...
    protected DropdownPopupWindow mDropdownPopupWindow;

    private boolean mSelectionNotified;

    public SelectPopupDropdown(ContentViewCore contentViewCore) {
    ...
    protected void notifySelection(int[] indicies) {
