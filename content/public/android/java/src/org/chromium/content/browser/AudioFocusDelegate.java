...
public class AudioFocusDelegate implements AudioManager.OnAudioFocusChangeListener {
    ...
    protected long mNativeAudioFocusDelegateAndroid;

    protected AudioFocusDelegate(long nativeAudioFocusDelegateAndroid) {
    ...
    protected boolean requestAudioFocusInternal() {
        AudioManager am = (AudioManager) ContextUtils.getApplicationContext().getSystemService(
                Context.AUDIO_SERVICE);
    ...
    protected native void nativeOnSuspend(long nativeAudioFocusDelegateAndroid);
