...
/* package */ class WebContentsImpl implements WebContents, RenderFrameHostDelegate {
    ...
    // VRBrowser++
    @Override
    public void insertCSSIncludingIFrame(String css) {
        if (isDestroyed()) return;
        nativeInsertCSSIncludingIFrame(mNativeWebContentsAndroid, css);
    }
    // VRBrowser--
    ...
    public void suspendMediaSession() {
        if (mMediaSession != null) mMediaSession.suspend();
    }
    ...
    // VRBrowser++
    private native void nativeInsertCSSIncludingIFrame(long nativeWebContentsAndroid, String css);
    // VRBrowser--
