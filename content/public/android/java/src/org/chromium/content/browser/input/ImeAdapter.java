...
public class ImeAdapter {
    ...
    protected void setInputConnection(ChromiumBaseInputConnection inputConnection) {
    ...
    protected boolean shouldRestartInput(int textInputType) {
        return mTextInputType != textInputType;
    }
    ...
    protected int getTextInputType() {
