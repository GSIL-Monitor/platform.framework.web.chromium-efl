...
public abstract class WebContentsObserver {
    ...
    /**
     * Notifies that a meta is available for a given frame.
     * @param frameId A positive, non-zero integer identifying the navigating frame.
     * @param isMainFrame Whether the load is happening for the main frame.
     * @param metaElements meta elements in the document in JSONString format.
     */
    public void didGetMeta(
            long frameId, boolean isMainFrame, String metaElements) {}
