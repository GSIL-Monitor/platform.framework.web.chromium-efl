...
EnumTraits<content::mojom::ResourceType, content::ResourceType>::ToMojom(
  ...
  switch (input) {
    ...
    case content::RESOURCE_TYPE_POPUP:
      return content::mojom::ResourceType::RESOURCE_TYPE_POPUP;
  ...
  switch (input) {
    ...
    case content::mojom::ResourceType::RESOURCE_TYPE_CSP_REPORT:
      *output = content::RESOURCE_TYPE_CSP_REPORT;
      return true;
    case content::mojom::ResourceType::RESOURCE_TYPE_POPUP:
      *output = content::RESOURCE_TYPE_POPUP;
      return true;
