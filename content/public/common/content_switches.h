...
CONTENT_EXPORT extern const char kForceAccelerated2dCanvas[];
#endif
...
CONTENT_EXPORT extern const char kUseSamsungMediaControls[];
...
CONTENT_EXPORT extern const char kEnableMediaSource[];
#endif
