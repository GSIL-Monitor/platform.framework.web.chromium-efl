...
WebPreferences::WebPreferences()
    : default_font_size(16),
      ...
      content_blocker_enabled(false),
      content_blocker_statistics_enabled(false),
      default_content_blocker_enabled(false),
      ...
      uses_encoding_detector(true),
      initial_list_style_position(LIST_STYLE_POSITION_OUTSIDE),
      viewport_meta_non_user_scalable_quirk(true),
      tizen_version({5, 0, 0}),
#endif
      night_mode_enabled(false),
      reader_night_mode_enabled(false),
      daydream_mode_enabled(false),
      gear_vr_mode_enabled(false),
#if defined(OS_TIZEN_TV_PRODUCT)
      allow_file_access_from_external_urls(false),
      media_playback_notification_enabled(false),
      media_subtitle_notification_enabled(false),
#endif
#if defined(OS_TIZEN)
      max_refresh_rate(-1),
#endif
      ...
      text_zoom_enabled(false),
      selection_magnifier_enabled(false),
      long_press_enabled(false),
#if defined(OS_TIZEN)
      mirror_blur_enabled(false),
#endif
#if defined(OS_ANDROID)
...
#endif  // defined(OS_ANDROID)
  if (IsMobileProfile() || IsWearableProfile() || IsDesktopProfile()) {
