...
IPC_STRUCT_TRAITS_BEGIN(content::WebPreferences)
  ...
  IPC_STRUCT_TRAITS_MEMBER(drag_drop_enabled)
  IPC_STRUCT_TRAITS_MEMBER(media_subtitle_notification_enabled)
#endif
#if defined(OS_TIZEN)
  IPC_STRUCT_TRAITS_MEMBER(max_refresh_rate)
#endif
  ...
  IPC_STRUCT_TRAITS_MEMBER(content_blocker_enabled)
  IPC_STRUCT_TRAITS_MEMBER(content_blocker_statistics_enabled)
  IPC_STRUCT_TRAITS_MEMBER(default_content_blocker_enabled)
  ...
  IPC_STRUCT_TRAITS_MEMBER(daydream_mode_enabled)
  IPC_STRUCT_TRAITS_MEMBER(gear_vr_mode_enabled)
#if defined(USE_EFL)
