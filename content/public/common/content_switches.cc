...
// Enable gpu-accelerated 2d canvas forcibly.
const char kForceAccelerated2dCanvas[]      = "force-accelerated-2d-canvas";
#endif
...
const char kUseSamsungMediaControls[] = "hide-blink-controls-for-fullscreen";
...
// Disable the MediaSource player
