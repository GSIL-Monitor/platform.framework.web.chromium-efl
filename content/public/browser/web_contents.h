...
class WebContents : public PageNavigator,
 ...
 public:
  ...
  virtual void SetLastSentThemeColor(SkColor theme_color) = 0;
  virtual SkColor GetLastSentThemeColor() const = 0;
#endif
  ...
  // VRBrowser++
  // Requests the renderer to insert CSS into the iframe's document.
  virtual void InsertCSSIncludingIFrame(const std::string& css) = 0;
  // VRBrowser--
...
#if defined(S_TERRACE_SUPPORT)
  virtual void RequestOpenWebLinkMatchInfos(int current_version) = 0;
#endif
  ...
  virtual void SetIMERecommendedWords(const std::string&) = 0;
  virtual void SetIMERecommendedWordsType(bool should_enable) = 0;
