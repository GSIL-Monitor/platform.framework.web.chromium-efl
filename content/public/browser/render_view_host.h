...
class CONTENT_EXPORT RenderViewHost : public IPC::Sender {
 public:
  ...
  virtual void MoveFocusToPrevNextInput(bool is_next) = 0;

#if defined(OS_ANDROID)
  // This api is used for retrieving the selection markup along with the bounds.
  virtual void GetSelectionMarkupWithBounds() = 0;
