...
// Notifies Render process is died
#if defined(S_TERRACE_SUPPORT)
  virtual void NotifyRendererDied() = 0;
#endif
...
// Notifies Render process is died
#if defined(S_TERRACE_SUPPORT)
  static void RunNotifyRendererDiedOnUIBrowserThread(int render_process_id);
  static void NotifyRendererDiedWithProcessID(int render_process_id);
#endif
