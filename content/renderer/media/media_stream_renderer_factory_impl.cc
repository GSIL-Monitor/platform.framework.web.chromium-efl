...
MediaStreamRendererFactoryImpl::GetVideoRenderer(
    ...
    const MediaStreamVideoRenderer::SuspendingDecoderCB& suspending_decoder_cb,
  ...
  return new MediaStreamVideoRendererSink(
      video_tracks[0], error_cb, repaint_cb, decoder_data_cb,
      suspending_decoder_cb, io_task_runner, media_task_runner,
