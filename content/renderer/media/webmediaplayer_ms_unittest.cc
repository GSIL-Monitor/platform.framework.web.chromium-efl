...
class MockRenderFactory : public MediaStreamRendererFactory {
 public:
  ...
  scoped_refptr<MediaStreamVideoRenderer> GetVideoRenderer(
      ...
      const base::Closure& error_cb,
      const MediaStreamVideoRenderer::RepaintCB& repaint_cb,
      const MediaStreamVideoRenderer::DecoderDataCB& decoder_data_cb,
...
class WebMediaPlayerMSTest
 ...
 public:
  ...
  bool textTracksVisible() const override { return false; }
  void setClosedCaptionVisibility(bool visible) override {}
  blink::WebURL closedCaptionSrc() const override { return blink::WebURL(); }
  blink::WebString dimension() const override { return blink::WebString(); }
  void requestFullscreen() override {}
  bool isMediaControlDisplayed() const override { return false; }
  double EffectiveMediaVolume() const override { return 0; }
#endif
