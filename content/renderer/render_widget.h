...
class CONTENT_EXPORT RenderWidget
 ...
 public:
  ...
  void DidInitializeRenderer() override;
#endif
  ...
  void UpdateSelectionBounds(bool is_multi_selection = false);
...
#if defined(OS_TIZEN)
  void DidChangeLoadState(bool is_loading);
#endif
...
// RenderWidget IPC message handlers
#if defined(USE_EFL)
  void OnUpdateRotationDegrees(int rotation_degrees);
#endif
#if defined(OS_TIZEN_TV_PRODUCT)
  void OnSetLayerInverted(bool inverted);
#endif

  void OnSetClearTilesOnHide(bool enable);
  ...
  void OnSetTileCoverAreaMultiplier(float cover_area_multiplier);
  ...
  void OnDefersLoading(bool defers);
  ...
  void OnFastScrollerEnabled(bool enabled);
#endif
  ...
  bool text_input_is_in_form_tag_;
#endif
