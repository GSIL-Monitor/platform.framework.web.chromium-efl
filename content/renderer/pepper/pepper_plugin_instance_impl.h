...
class CONTENT_EXPORT PepperPluginInstanceImpl
...
#if defined(TIZEN_PEPPER_PLAYER)
  class GeometryChangeListener {
   public:
    virtual ~GeometryChangeListener();
    virtual void GeometryDidChange(const PP_Rect&) = 0;
  };
...
#if defined(TIZEN_PEPPER_PLAYER)
  void AddGeometryChangeListener(GeometryChangeListener* listener);
  void RemoveGeometryChangeListener(GeometryChangeListener* listener);
#endif  // defined(TIZEN_PEPPER_PLAYER)
 ...
 private:
  ...
  scoped_refptr<cc::VideoLayer> video_layer_;  // Used by PepperPlayer
...
#if defined(TIZEN_PEPPER_PLAYER)
  PepperMediaPlayerRendererHost* bound_player_;
#endif
...
#if defined(TIZEN_PEPPER_PLAYER)
  std::vector<GeometryChangeListener*> geometry_listeners_;
#endif  // defined(TIZEN_PEPPER_PLAYER)
