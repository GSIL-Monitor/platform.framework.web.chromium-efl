...
class HostArrayBufferViewVar : public ppapi::ArrayBufferVar {
 public:
  explicit HostArrayBufferViewVar(const blink::WebArrayBufferView& buffer);
 ...
 private:
  ~HostArrayBufferViewVar() override;

  blink::WebArrayBufferView buffer_;
  // Tracks whether the data in the buffer is valid.
  bool valid_;

  DISALLOW_COPY_AND_ASSIGN(HostArrayBufferViewVar);
};
