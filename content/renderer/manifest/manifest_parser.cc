...
#if defined(USE_EFL)
  manifest_.spp_sender_id = ParseSPPSenderID(*dictionary);
#endif
...
#if defined(USE_EFL)
base::NullableString16 ManifestParser::ParseSPPSenderID(
    const base::DictionaryValue& dictionary) {
  return ParseString(dictionary, "spp_sender_id", Trim);
}
#endif
