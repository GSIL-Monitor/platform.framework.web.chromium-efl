...
bool RendererDateTimePicker::OnMessageReceived(const IPC::Message& message) {
  bool handled = true;
  IPC_BEGIN_MESSAGE_MAP(RendererDateTimePicker, message)
  IPC_MESSAGE_HANDLER(ViewMsg_ReplaceDateTime, OnReplaceDateTime)
#if defined(USE_EFL)
  IPC_MESSAGE_HANDLER(ViewMsg_ReplaceDateTime_String,
                      OnReplaceDateTimeWithString)
#endif
...
#if defined(USE_EFL)
void RendererDateTimePicker::OnReplaceDateTimeWithString(
