...
class CONTENT_EXPORT NavigationControllerImpl : public NavigationController {
 public:
  ...
  void InsertEntry(const GURL& url,
 ...
 private:
  ...
  // Whether to reload the currently navigated page for maintaining correct
  // desktop/mobile mode, which is set for current tab.
  bool back_forward_needs_reload_;
