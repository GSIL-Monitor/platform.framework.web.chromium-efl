...
class InterstitialPageImpl::InterstitialPageRVHDelegateView
 ...
 public:
  ...
  void SelectedMarkup(const base::string16& markup) override;
  void SelectedBitmap(const SkBitmap& bitmap) override;
...
void InterstitialPageImpl::InterstitialPageRVHDelegateView::SelectedMarkup(
    const base::string16& markup) {
}

void InterstitialPageImpl::InterstitialPageRVHDelegateView::SelectedBitmap(
