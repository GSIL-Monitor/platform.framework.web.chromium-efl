...
class CONTENT_EXPORT RenderFrameHostImpl
 ...
 public:
  ...
  float AccessibilityGetPageScaleFactor() const override;
  gfx::Vector2dF AccessibilityGetScrollOffset() override;
#endif
  ...
  // Get the advanced IME options for Select Dialog Form Navigation
  int GetAdvancedImeOptionsForSelectDialog() const {
    return select_dialog_advanced_ime_options_;
  }
 ...
 private:
  ...
  void CreateFullscreenVideoContextMenu(GURL url) override;
#endif
  ...
  */
  ...
  // Stores the advanced IME options for Form Navigation
  int select_dialog_advanced_ime_options_;
