...
#ifndef CONTENT_BROWSER_UI_AUTOFILL_AUTOFILL_POPUP_CONTROLLER_IMPL_H_
#define CONTENT_BROWSER_UI_AUTOFILL_AUTOFILL_POPUP_CONTROLLER_IMPL_H_
...
#include "content/browser/ui/autofill/popup_controller_common.h"
...
class AutofillPopupControllerImpl : public AutofillPopupController {
 ...
 private:
  ...
  #include "autofill_popup_controller_impl_sec.h"

  base::WeakPtrFactory<AutofillPopupControllerImpl> weak_ptr_factory_;
};

bool RegisterAutofillPopupController(JNIEnv* env);

}  // namespace autofill

#endif  // CONTENT_BROWSER_UI_AUTOFILL_AUTOFILL_POPUP_CONTROLLER_IMPL_H_
