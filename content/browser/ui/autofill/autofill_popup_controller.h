...
#ifndef CONTENT_BROWSER_UI_AUTOFILL_AUTOFILL_POPUP_CONTROLLER_H_
#define CONTENT_BROWSER_UI_AUTOFILL_AUTOFILL_POPUP_CONTROLLER_H_
...
class AutofillPopupController : public AutofillPopupViewDelegate {
 public:
  ...
  virtual void SetAboveAnchor(bool above) = 0;
 protected:
...
#endif  // CONTENT_BROWSER_UI_AUTOFILL_AUTOFILL_POPUP_CONTROLLER_H_
