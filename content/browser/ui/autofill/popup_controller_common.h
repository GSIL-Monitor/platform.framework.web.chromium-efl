...
#ifndef CONTENT_BROWSER_UI_AUTOFILL_POPUP_CONTROLLER_COMMON_H_
#define CONTENT_BROWSER_UI_AUTOFILL_POPUP_CONTROLLER_COMMON_H_
...
#endif  // CONTENT_BROWSER_UI_AUTOFILL_POPUP_CONTROLLER_COMMON_H_
