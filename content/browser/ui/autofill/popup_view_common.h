...
#ifndef CONTENT_BROWSER_UI_AUTOFILL_POPUP_VIEW_COMMON_H_
#define CONTENT_BROWSER_UI_AUTOFILL_POPUP_VIEW_COMMON_H_
...
#endif  // CONTENT_BROWSER_UI_AUTOFILL_POPUP_VIEW_COMMON_H_
