...
class CONTENT_EXPORT BrowserMediaPlayerManager
 ...
 public:
  ...
  virtual void OnUpdateClosedCaptions(int player_id, int status) { }
  virtual void OnUpdateFullscreenBufferedPercent(int player_id,
                                                 int percentage) { }
...
#if defined(S_TERRACE_SUPPORT)
  void PlayMedia(int player_id) override { }
  void PauseMedia(int player_id) override { }
#endif
