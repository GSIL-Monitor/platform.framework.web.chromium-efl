...
/*#if defined(S_TERRACE_SUPPORT)
    IPC_MESSAGE_FORWARD(MediaPlayerHostMsg_UpdateClosedCaptions,
                        GetMediaPlayerManager(render_frame_host),
                        BrowserMediaPlayerManager::OnUpdateClosedCaptions)
    IPC_MESSAGE_FORWARD(MediaPlayerHostMsg_UpdateFullscreenBufferedPercent,
        GetMediaPlayerManager(render_frame_host),
        BrowserMediaPlayerManager::OnUpdateFullscreenBufferedPercent)
