...
class CONTENT_EXPORT ContentViewCore : public WebContentsObserver {
 public:
  ...
  virtual void SelectedMarkupWithStartContentRect(
      const base::string16& markup,
      const gfx::Rect& selection_start_content_rect) {}
