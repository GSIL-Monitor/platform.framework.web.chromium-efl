...
class CONTENT_EXPORT ContentViewRenderView : public CompositorClient {
 public:
  ...
  virtual void SetCurrentWebContents(
      JNIEnv* env,
  ...
  void SurfaceDestroyed(JNIEnv* env,
                        const base::android::JavaParamRef<jobject>& obj);
  virtual void SurfaceChanged(JNIEnv* env,
                      const base::android::JavaParamRef<jobject>& obj,
                      jint format,
                      jint width,
                      jint height,
 ...
 protected:
  ...
  void ResetCompositor(content::Compositor* compositor);
