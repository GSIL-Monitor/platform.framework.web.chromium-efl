...
#if defined(TIZEN_ATK_SUPPORT)
  virtual float AccessibilityGetPageScaleFactor() const = 0;
  virtual gfx::Vector2dF AccessibilityGetScrollOffset() = 0;
#endif
};
...
#if defined(TIZEN_ATK_SUPPORT)
  BrowserAccessibilityManagerEfl* ToBrowserAccessibilityManagerEfl();
#endif
