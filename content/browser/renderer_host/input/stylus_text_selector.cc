...
bool StylusTextSelector::IsTextSelectionTriggered() {
  return text_selection_triggered_;
}

void StylusTextSelector::SetTextSelectionTriggered(bool triggered) {
  text_selection_triggered_ = triggered;
}

bool StylusTextSelector::IsSecondaryButtonPressed() {
  return secondary_button_pressed_;
}

void StylusTextSelector::SetSecondaryButtonPressed(bool pressed) {
  secondary_button_pressed_ = pressed;
}

float StylusTextSelector::GetAnchorX() {
  return anchor_x_;
}

float StylusTextSelector::GetAnchorY() {
  return anchor_y_;
}

void StylusTextSelector::SetAnchorX(float x_pos) {
  anchor_x_ = x_pos;
}

void StylusTextSelector::SetAnchorY(float y_pos) {
  anchor_y_ = y_pos;
}

bool StylusTextSelector::ShouldStartStylusTextSelection(
      const ui::MotionEvent& event) {
  return ShouldStartTextSelection(event);
}
