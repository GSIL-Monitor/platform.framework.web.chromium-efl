...
void TouchSelectionControllerClientAura::OnSelectionEvent(
  ...
  switch (event) {
    ...
    case ui::SELECTION_IN_PROGRESS:
    case ui::SELECTION_TOOLTIP_SHOWN:
    case ui::SELECTION_TOOLTIP_HIDE:
    case ui::SELECTION_VIBRATE:
    case ui::SELECTION_ESTABLISHED_LONG_PRESS:
    case ui::SELECTION_AUTO_SCROLL_BEGIN:
    case ui::SELECTION_TEXT_MAGNIFIER_SHOWN:
    case ui::SELECTION_TEXT_MAGNIFIER_HIDDEN:
      break;
  };
}
