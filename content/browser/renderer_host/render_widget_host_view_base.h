...
class CONTENT_EXPORT RenderWidgetHostViewBase : public RenderWidgetHostView,
 ...
 public:
  ...
  // The height of the Bottom-bar controls.
  virtual float GetBottomControlsHeight() const;

  // Ack the Resize viewport message with new size.
  virtual void DidReceiveResizeAck(const gfx::Size& new_size) const {}
  ...
  virtual void NotifyScrollbarState(bool disable, bool visible) {}
#endif
  ...
  virtual void OnRecognizeArticleResult(
  ...
  base::string16 GetSelectionText();
#endif
