...
class CONTENT_EXPORT RenderProcessHostImpl
 ...
 public:
  ...
  void NotifyRendererDied() override;
#endif
  ...
  const scoped_refptr<BrowserMessageFilter>& browser_demuxer_efl() {
    return browser_demuxer_efl_;
  }
#endif
...
#if defined(TIZEN_MULTIMEDIA_SUPPORT)
  scoped_refptr<BrowserMessageFilter> browser_demuxer_efl_;

#if defined(TIZEN_TBM_SUPPORT)
  scoped_refptr<BrowserMessageFilter> browser_mediapacket_manager_;
#endif
#endif
