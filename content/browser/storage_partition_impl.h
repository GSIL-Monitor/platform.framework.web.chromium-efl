...
class CONTENT_EXPORT StoragePartitionImpl
...
#if defined(OS_TIZEN_TV_PRODUCT)
  void AddObserver(StoragePartitionPathObserver* observer);
  void RemoveObserver(StoragePartitionPathObserver* observer);

  // For process which was preloaded with unknow app id to override the path
 ...
 private:
  ...
  base::ObserverList<StoragePartitionPathObserver> observers_;
#endif
