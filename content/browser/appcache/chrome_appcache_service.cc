...
#if defined(OS_TIZEN_TV_PRODUCT)
void ChromeAppCacheService::UpdatePath(const base::FilePath& path) {
  if (BrowserThread::CurrentlyOn(BrowserThread::IO)) {
    base::FilePath cache_path = path.Append(kAppCacheDirname);
    cache_path_ = cache_path;
    ...
    BrowserThread::PostTask(
        ...
        base::Bind(&ChromeAppCacheService::UpdatePath, this, path));
  }
}
#endif
