...
#include "content/public/browser/storage_partition_path_observer.h"
#endif
...
class CONTENT_EXPORT ServiceWorkerContextWrapper
...
#if defined(OS_TIZEN_TV_PRODUCT)
      public StoragePartitionPathObserver,
#endif
...
#if defined(OS_TIZEN_TV_PRODUCT)
  // StoragePartitionPathObserver implementation
  void UpdatePath(const base::FilePath& path) override;
#endif
 ...
 private:
  ...
  friend class TinServiceWorkerInternalsUI;
#endif
