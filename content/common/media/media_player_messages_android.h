...
// Set closed captions visibility.
IPC_MESSAGE_ROUTED2(MediaPlayerMsg_SetClosedCaptionVisibility,
                    int /*player_id */,
                    bool /*visible */)
...
// Completed a intializing media player object
IPC_MESSAGE_ROUTED1(MediaPlayerMsg_InitCompleted,
                    int /* player_id */)

// Set audio only mode to render media player manager.
IPC_MESSAGE_ROUTED2(MediaPlayerMsg_SetAudioOnlyMode,
                    int /* player_id */,
                    bool /* enable */)
#endif
...
#if defined(S_TERRACE_SUPPORT)
// Update buffering percentage for fullscreen video when MSE is used.
IPC_MESSAGE_ROUTED2(MediaPlayerHostMsg_UpdateFullscreenBufferedPercent,
                    int /* player_id */,
                    int /* status */)

// Update closed caption source
IPC_MESSAGE_ROUTED2(MediaPlayerHostMsg_UpdateClosedCaptionSrc,
                    int /* player_id */,
                    std::string /* src */)

// Update closed captions button visibility for fullscreen controller.
IPC_MESSAGE_ROUTED2(MediaPlayerHostMsg_UpdateClosedCaptionStatus,
                    int /* player_id */,
                    int /* status */)

// Update dimension type for 360 player.
IPC_MESSAGE_ROUTED2(MediaPlayerHostMsg_UpdateDimension,
                    int /* player_id */,
                    std::string /* type */)

// Exit Full screen video by FullscreenController.
IPC_MESSAGE_ROUTED1(MediaPlayerHostMsg_ExitFullscreen,
                    int /* player_id */)

// Notify media control changed displaying
IPC_MESSAGE_ROUTED2(MediaPlayerHostMsg_IsMediaControlDisplayed,
                    int /* player_id */,
                    bool /* is_displayed */)

// Notify playback rate change
IPC_MESSAGE_ROUTED2(MediaPlayerHostMsg_UpdatePlayRate,
                    int /* player_id */,
                    double /* rate */)
#endif
