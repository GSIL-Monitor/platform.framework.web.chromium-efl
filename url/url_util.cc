...
const SchemeWithType kStandardURLSchemes[] = {
    ...
    {kDvbScheme, SCHEME_WITH_PORT},
    {kTVKeyScheme, SCHEME_WITH_PORT},
    {kOpAppScheme, SCHEME_WITH_PORT},
    {kHbbTVCarouselScheme, SCHEME_WITHOUT_PORT},
    {kCIScheme, SCHEME_WITH_PORT},
#endif
};
...
#if defined(OS_TIZEN_TV_PRODUCT)
size_t MaxURLChars = 2 * 1024 * 1024;

size_t GetMaxURLChars() {
  return MaxURLChars;
}
void SetMaxURLCharSize(size_t url_size) {
  MaxURLChars = url_size;
}
#endif
