...
#else
  // Replaced with sandbox check from renderer_main_platform_delegate_linux.cc.
  // The check above doesn't work on tizen TV.
  return !base::PathExists(base::FilePath("/proc/cpuinfo"));
#endif
}
