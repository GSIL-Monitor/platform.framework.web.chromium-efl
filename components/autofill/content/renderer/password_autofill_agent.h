...
class PasswordAutofillAgent : public content::RenderFrameObserver,
 ...
 private:
  ...
  // Autologin agent takes care of automatic login without a need for user to
  // to click submit button.
  PasswordAutologinAgent* password_autologin_agent_;
  ...
  // Indicates that we are sending submit event
