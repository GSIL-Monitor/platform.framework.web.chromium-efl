...
struct StructTraits<autofill::mojom::PasswordFormFillDataDataView,
  ...
  static const base::string16& selected_user(
      const autofill::PasswordFormFillData& r) {
    return r.selected_user;
  }

  static bool username_element_readonly(
      const autofill::PasswordFormFillData& r) {
    return r.username_element_readonly;
  }

  static bool manual_autofill(
      const autofill::PasswordFormFillData& r) {
    return r.manual_autofill;
  }

  static bool autologin_required(
      const autofill::PasswordFormFillData& r) {
    return r.autologin_required;
  }

  static const std::vector<base::string16>& username_list(
      const autofill::PasswordFormFillData& r) {
    return r.username_list;
  }
...
struct StructTraits<autofill::mojom::PasswordFormDataView,
  ...
  static bool username_element_readonly(const autofill::PasswordForm& r) {
    return r.username_element_readonly;
  }
