...
void AutofillWebDataService::AddUpiData(const UPIName& upi_data) {}

void AutofillWebDataService::UpdateUpiData(const UPIName& upi_data) {}

void AutofillWebDataService::RemoveUpiData(const std::string& guid) {}

WebDataServiceBase::Handle AutofillWebDataService::GetUpiData(
    WebDataServiceConsumer* consumer) {
  return 0;
}
