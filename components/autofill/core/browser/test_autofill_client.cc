...
void TestAutofillClient::AuthenticateCreditCardAutofill(
...
void TestAutofillClient::ConfirmSaveCreditCardToSamsungPay(
    const CreditCard& card) {
}

void TestAutofillClient::ConfirmSaveUPILocally(const UPIName& upi_name,
                                               const base::Closure& callback) {}
#endif
