...
bool FormStructure::IsAutofillable() const {
  if (autofill_count() < kRequiredFieldsForPredictionRoutines && !is_upi_form())
    return false;
...
// In certain web contents cached form would already have value
// entered by user. This doesn't mean its value is set by default.
// Therefore value of field should not be updated to NULL.
