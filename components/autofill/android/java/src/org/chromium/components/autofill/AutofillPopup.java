...
public class AutofillPopup extends DropdownPopupWindow implements AdapterView.OnItemClickListener,
    ...
    private static final int ITEM_ID_HAS_CREDIT_CARD = -99;
    private static final int ITEM_ID_CREDIT_CARD_HELPER = -100;
    ...
    public void filterAndShow(AutofillSuggestion[] suggestions, boolean isRtl,
        ...
        for (int i = 0; i < suggestions.length; i++) {
            ...
            } else if (itemId != ITEM_ID_HAS_CREDIT_CARD && itemId != ITEM_ID_CREDIT_CARD_HELPER) {
