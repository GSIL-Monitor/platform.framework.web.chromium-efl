...
class LoginDatabase {
 public:
  ...
  bool GetLoginsWithBio(
      std::vector<std::unique_ptr<autofill::PasswordForm>>* forms);
  // Gets a regular expression for Public Suffix Domain match.
  std::string GetRegexpForPSLDomainMatch(const PasswordStore::FormDigest& form);
  bool DropLoginsTableIfNecessary();
#endif
