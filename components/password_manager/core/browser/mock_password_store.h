...
// TODO(crbug.com/706392): Fix password reuse detection for Android.
  ...
  bool GetSavedPasswordData(
      std::vector<std::unique_ptr<autofill::PasswordForm>>* forms) override;
  std::string GetRegexpForPSLDomainMatch(
      const PasswordStore::FormDigest& form) override;
  void RemoveBiometricLogins(const base::Closure& completion) override;
  void RemoveBiometricLoginsImpl() override;
#endif
