...
class ThumbnailDatabase {
 public:
  ...
  // This method is used to store the icon's dominant color in Favicon DB.
  // |url| Favicon image's icon url.
  // |dominantColor| Favicon image's dominant color.
  void UpdateDominantColor(const GURL& icon_url, unsigned int dominant_color);
 ...
 private:
  ...
  // Adds support for dominant color in favicons table.
