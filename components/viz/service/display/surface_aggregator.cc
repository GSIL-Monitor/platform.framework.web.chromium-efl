...
gfx::Rect SurfaceAggregator::PrewalkTree(const SurfaceId& surface_id,
  ...
  if (!frame.metadata.root_scroll_offset.IsZero() ||
      ((frame.metadata.top_controls_height *
        frame.metadata.top_controls_shown_ratio) != 0)) {
    TRACE_EVENT_INSTANT2("cc", "SurfaceScrollOffset", TRACE_EVENT_SCOPE_THREAD,
                         "location_bar_offset",
                         frame.metadata.top_controls_height *
                             frame.metadata.top_controls_shown_ratio,
                         "root_scroll_offset",
                         frame.metadata.root_scroll_offset.y());
  }
