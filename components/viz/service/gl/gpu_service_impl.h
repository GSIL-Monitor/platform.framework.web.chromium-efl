...
class VIZ_SERVICE_EXPORT GpuServiceImpl : public gpu::GpuChannelManagerDelegate,
 ...
 public:
  ...
  gpu::DirectCanvasGpuChannelManager* direct_canvas_gpu_channel_mananger() {
    return direct_canvas_gpu_channel_manager_.get();
  }
#endif
...
#if defined(DIRECT_CANVAS)
  void set_direct_canvas_gpu_channel_manager(
      gpu::DirectCanvasGpuChannelManager* direct_canvas_gpu_channel_manager) {
    direct_canvas_gpu_channel_manager_.reset(direct_canvas_gpu_channel_manager);
  }
#endif
...
#if defined(DIRECT_CANVAS)
  std::unique_ptr<gpu::DirectCanvasGpuChannelManager>
      direct_canvas_gpu_channel_manager_;
#endif
