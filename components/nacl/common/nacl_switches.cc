...
// Enable Dlog support for NaCl Process
extern const char kEnableNaClDlog[] = "enable-nacl-dlog";
// Enable Native Client zygote preloading
const char kEnableNaClZygotePreloading[]    = "enable-nacl-zygote-preloading";
#endif
