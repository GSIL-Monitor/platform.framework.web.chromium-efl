...
/*****************************************************************************
 * Solve c11 compile problem
 * Google add "-std=c11" in build/config/compiler/BUILD.gn
 * tizen toolchain is not compatible with both c11 and asm
 * define asm as __asm__, to keep c11 enable in source file include asm
 */
