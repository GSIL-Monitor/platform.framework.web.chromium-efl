...
class Target {
 ...
 protected:
  ...
  void AddStepBreakPoint(port::Thread* thread);
  void RemoveStepBreakPoint();
 ...
 private:
  ...
  // If non-zero, a step breakpoint is set at the given untrusted
  // code address.
  uint32_t step_breakpoint_addr_;
