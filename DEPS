...
vars = {
  # SE server has no host data for git.sec.samsung.net
  'samsung_gitswarm': 'git@165.213.148.93',
...
# FIXME: Commented this till gitswarm has the latest breakpad version
#    Var('samsung_gitswarm') + ':PUBLIC/breakpad.git@dbdb11f2442b552e8a5e288b45a969e4325f0c99',

  'src/third_party/catapult':
    Var('samsung_gitswarm') + ':PUBLIC/catapult.git' + '@' + Var('catapult_revision'),
