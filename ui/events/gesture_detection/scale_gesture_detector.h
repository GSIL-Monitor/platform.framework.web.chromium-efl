...
class GESTURE_DETECTION_EXPORT ScaleGestureDetector {
 public:
  ...
  void GetArea(const MotionEvent& event);
  void ResetArea();
 ...
 private:
  ...
  SaveState state_current_;
  bool update_previous_;
  bool area_rate_calculating_;
  float temp_len_before_sqrt_;
  float curr_len_before_sqrt_;
  float prev_len_before_sqrt_;
#endif
