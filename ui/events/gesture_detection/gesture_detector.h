...
class GESTURE_DETECTION_EXPORT GestureDetector {
 public:
  ...
  void SetDefaultFlingMultiplier(float muliplier) {
    default_fling_multiplier_ = muliplier;
  }
 ...
 private:
  ...
  float overall_velocity_x_;
  float overall_velocity_y_;
  ...
  base::TimeTicks curr_event_time_;
  base::TimeTicks last_event_time_;
  bool vr_controller_scroll_;
  float default_fling_multiplier_;
