...
public class ViewConfigurationHelper {
    ...
    private static final float ANDROID_DEFAULT_TOUCH_SLOP = 8.0f;
    ...
    private float getTouchSlop() {
        if (toDips(mViewConfiguration.getScaledTouchSlop()) > ANDROID_DEFAULT_TOUCH_SLOP) {
            return ANDROID_DEFAULT_TOUCH_SLOP;
        }
