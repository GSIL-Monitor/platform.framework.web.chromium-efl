    ...
    public DropdownPopupWindow(Context context, View anchorView) {
        ...
        mLayoutChangeListener = new OnLayoutChangeListener() {
            ...
            public void onLayoutChange(View v, int left, int top, int right, int bottom,
                ...
                if (v == mAnchorView && mAdapter != null) DropdownPopupWindow.this.show();
            }
        };
        ...
        try {
            final String popupMemberName = "mPopup";
            Field f = ListPopupWindow.class.getDeclaredField(popupMemberName);
            if (f != null) {
            ...
            Log.e(TAG, "Fail to get the PopupWindow from super");
        }
    }

    /**
     *  HACK but this is only way we can know the isAboveAnchor of PopupWindow
     */
    public boolean isAboveAnchor() {
        if (mSuperPopup != null) return mSuperPopup.isAboveAnchor();
        return false;
    }
