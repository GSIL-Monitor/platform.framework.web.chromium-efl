...
public class Clipboard implements ClipboardManager.OnPrimaryClipChangedListener {
    ...
    @CalledByNative
    private void clear() {
        // Sending empty content to Clipboard has buggy effect in Samsung Clipboard. Also it's safe
        // in Android clipboard as well.
        // setPrimaryClipNoException(ClipData.newPlainText(null, null));
    }

    public void setPrimaryClipNoException(ClipData clip) {
        try {
            if (sListener != null && sListener.copyToSecClipboard(clip)) return;
    ...
    /**
     * Interface to update Sec Clipboard.
     */
    public interface ClipboardListener {
        /**
         * Notify app for copying data to SecClipboard.
         * @param clip Data to be copied to clipboard.
         * @return true when successfully copied to Sec Clipboard. false otherwise.
         */
        boolean copyToSecClipboard(ClipData clip);
    }

    private static ClipboardListener sListener = null;
