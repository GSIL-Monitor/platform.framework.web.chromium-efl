...
DelegatedFrameHostAndroid::CreateDelegatedLayer() {
  return CreateSurfaceLayer(frame_sink_manager_->surface_manager(),
                            surface_info_,
                            !has_transparent_background_);
}

gfx::Size DelegatedFrameHostAndroid::GetTextureSizeInLayer() {
