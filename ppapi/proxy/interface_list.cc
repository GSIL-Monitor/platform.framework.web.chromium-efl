...
InterfaceList::InterfaceList() {
...
#if defined(TIZEN_PEPPER_EXTENSIONS) || defined(TIZEN_PEPPER_PLAYER)
    #include "ppapi/thunk/interfaces_ppb_samsung.h"
#endif  // defined(TIZEN_PEPPER_EXTENSIONS) || defined(TIZEN_PEPPER_PLAYER)
  }
  {
  ...
  AddPPB(PPB_TESTING_PRIVATE_INTERFACE, PPB_Testing_Proxy::GetProxyInterface(),
         PERMISSION_TESTING);

#if defined(TIZEN_PEPPER_EXTENSIONS)
  AddProxy(API_ID_PPB_TESTING_SAMSUNG,
           &ProxyFactory<PPB_Testing_Samsung_Proxy>);
  AddPPB(PPB_TESTING_SAMSUNG_INTERFACE_1_0,
         PPB_Testing_Samsung_Proxy::GetProxyInterface(), PERMISSION_TESTING);
#endif
