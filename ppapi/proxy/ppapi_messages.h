...
#if defined(TIZEN_PEPPER_EXTENSIONS)
IPC_ENUM_TRAITS_MAX_VALUE(PP_VideoLatencyMode, PP_VIDEOLATENCYMODE_LAST)
#endif
...
#if defined(TIZEN_PEPPER_EXTENSIONS)
  IPC_STRUCT_TRAITS_MEMBER(background_plane)
#endif
IPC_STRUCT_TRAITS_END()
...
#if defined(TIZEN_PEPPER_EXTENSIONS)
IPC_STRUCT_TRAITS_BEGIN(ppapi::CompositorLayerData::BackgroundPlaneLayer)
IPC_STRUCT_TRAITS_END()
#endif
...
IPC_ENUM_TRAITS_MAX_VALUE(PP_AudioCodec_Type_Samsung,
                          PP_AUDIOCODEC_TYPE_SAMSUNG_MAX)
IPC_ENUM_TRAITS_MIN_MAX_VALUE(PP_AudioCodec_Profile_Samsung,
                              PP_AUDIOCODEC_PROFILE_SAMSUNG_UNKNOWN,
                              PP_AUDIOCODEC_PROFILE_SAMSUNG_LAST)
IPC_ENUM_TRAITS_MAX_VALUE(PP_SampleFormat_Samsung, PP_SAMPLEFORMAT_SAMSUNG_MAX)
IPC_ENUM_TRAITS_MAX_VALUE(PP_ChannelLayout_Samsung,
                          PP_CHANNEL_LAYOUT_SAMSUNG_MAX)
IPC_ENUM_TRAITS_MAX_VALUE(PP_VideoCodec_Type_Samsung,
                          PP_VIDEOCODEC_TYPE_SAMSUNG_LAST)
IPC_ENUM_TRAITS_MIN_MAX_VALUE(PP_VideoCodec_Profile_Samsung,
                              PP_VIDEOCODEC_PROFILE_SAMSUNG_UNKNOWN,
                              PP_VIDEOCODEC_PROFILE_SAMSUNG_LAST)
IPC_ENUM_TRAITS_MAX_VALUE(PP_VideoFrame_Format_Samsung,
                          PP_VIDEOFRAME_FORMAT_SAMSUNG_LAST)
IPC_ENUM_TRAITS_MIN_MAX_VALUE(PP_ElementaryStream_Type_Samsung,
                              PP_ELEMENTARYSTREAM_TYPE_SAMSUNG_UNKNOWN,
                              PP_ELEMENTARYSTREAM_TYPE_SAMSUNG_MAX)
IPC_ENUM_TRAITS_MIN_MAX_VALUE(PP_StreamInitializationMode,
                              PP_STREAMINITIALIZATIONMODE_FULL,
                              PP_STREAMINITIALIZATIONMODE_MINIMAL)
...
IPC_STRUCT_TRAITS_BEGIN(PP_VideoTrackInfo)
IPC_STRUCT_TRAITS_MEMBER(index)
IPC_STRUCT_TRAITS_MEMBER(bitrate)
IPC_STRUCT_TRAITS_MEMBER(size)
IPC_STRUCT_TRAITS_END()

IPC_STRUCT_TRAITS_BEGIN(PP_AudioTrackInfo)
IPC_STRUCT_TRAITS_MEMBER(index)
IPC_STRUCT_TRAITS_MEMBER(language)
IPC_STRUCT_TRAITS_END()

IPC_STRUCT_TRAITS_BEGIN(PP_TextTrackInfo)
IPC_STRUCT_TRAITS_MEMBER(index)
IPC_STRUCT_TRAITS_MEMBER(is_external)
IPC_STRUCT_TRAITS_MEMBER(language)
IPC_STRUCT_TRAITS_END()

IPC_STRUCT_TRAITS_BEGIN(ppapi::AudioCodecConfig)
IPC_STRUCT_TRAITS_MEMBER(codec)
IPC_STRUCT_TRAITS_MEMBER(profile)
IPC_STRUCT_TRAITS_MEMBER(sample_format)
...
IPC_STRUCT_TRAITS_BEGIN(ppapi::VideoCodecConfig)
IPC_STRUCT_TRAITS_MEMBER(codec)
IPC_STRUCT_TRAITS_MEMBER(profile)
IPC_STRUCT_TRAITS_MEMBER(frame_format)
IPC_STRUCT_TRAITS_MEMBER(frame_size)
IPC_STRUCT_TRAITS_MEMBER(frame_rate)
IPC_STRUCT_TRAITS_MEMBER(extra_data)
IPC_STRUCT_TRAITS_END()
...
#if defined(TIZEN_PEPPER_TEEC)
IPC_ENUM_TRAITS_MAX_VALUE(PP_TEEC_Return_Origin, PP_TEEC_ORIGIN_LAST)

IPC_STRUCT_TRAITS_BEGIN(PP_TEEC_Result)
IPC_STRUCT_TRAITS_MEMBER(return_code)
IPC_STRUCT_TRAITS_MEMBER(return_origin)
IPC_STRUCT_TRAITS_END()

IPC_STRUCT_TRAITS_BEGIN(PP_TEEC_UUID)
IPC_STRUCT_TRAITS_MEMBER(time_low)
IPC_STRUCT_TRAITS_MEMBER(time_mid)
IPC_STRUCT_TRAITS_MEMBER(time_hi_and_version)
IPC_STRUCT_TRAITS_MEMBER(clock_seq_and_node)
IPC_STRUCT_TRAITS_END()

IPC_STRUCT_TRAITS_BEGIN(PP_TEEC_TempMemoryReference)
IPC_STRUCT_TRAITS_MEMBER(size)
IPC_STRUCT_TRAITS_END()

IPC_STRUCT_TRAITS_BEGIN(PP_TEEC_RegisteredMemoryReference)
IPC_STRUCT_TRAITS_MEMBER(parent)
IPC_STRUCT_TRAITS_MEMBER(offset)
IPC_STRUCT_TRAITS_MEMBER(size)
IPC_STRUCT_TRAITS_END()

IPC_STRUCT_TRAITS_BEGIN(PP_TEEC_Value)
IPC_STRUCT_TRAITS_MEMBER(a)
IPC_STRUCT_TRAITS_MEMBER(b)
IPC_STRUCT_TRAITS_END()

IPC_STRUCT_TRAITS_BEGIN(PP_TEEC_Parameter)
IPC_STRUCT_TRAITS_MEMBER(tmpref)
IPC_STRUCT_TRAITS_MEMBER(memref)
...
#if defined(TIZEN_PEPPER_EXTENSIONS)
// PPB_Testing_Samsung
IPC_MESSAGE_ROUTED1(PpapiHostMsg_PPBTestingSamsung_LoseContext,
                    PP_Instance /* instance */)
...
#if defined(TIZEN_PEPPER_EXTENSIONS)
IPC_MESSAGE_CONTROL5(PpapiHostMsg_VideoDecoder_Initialize,
...
IPC_MESSAGE_CONTROL0(PpapiPluginMsg_ElementaryStream_FlushReply)
IPC_MESSAGE_CONTROL2(PpapiHostMsg_ElementaryStream_SetDRMInitData,
                     std::vector<uint8_t> /* type */,
                     std::vector<uint8_t> /* init_data */)
IPC_MESSAGE_CONTROL0(PpapiPluginMsg_ElementaryStream_SetDRMInitDataReply)

// PPBAudioElementaryStream messages:
IPC_MESSAGE_CONTROL2(PpapiHostMsg_AudioElementaryStream_InitializeDone,
                     PP_StreamInitializationMode /* mode */,
                     ppapi::AudioCodecConfig /* config */)
IPC_MESSAGE_CONTROL0(PpapiPluginMsg_AudioElementaryStream_InitializeDoneReply)

// PPBVideoElementaryStream messages:
IPC_MESSAGE_CONTROL2(PpapiHostMsg_VideoElementaryStream_InitializeDone,
                     PP_StreamInitializationMode /* mode */,
                     ppapi::VideoCodecConfig /* config */)
IPC_MESSAGE_CONTROL0(PpapiPluginMsg_VideoElementaryStream_InitializeDoneReply)

// ESDataSource ---------------------------------------------------------------

IPC_MESSAGE_CONTROL0(PpapiHostMsg_ESDataSource_Create)
IPC_MESSAGE_CONTROL1(PpapiHostMsg_ESDataSource_AddStream,
                     PP_ElementaryStream_Type_Samsung)
IPC_MESSAGE_CONTROL2(PpapiPluginMsg_ESDataSource_AddStreamReply,
                     PP_ElementaryStream_Type_Samsung /* type */,
                     int /* pending_host_id */)
IPC_MESSAGE_CONTROL1(PpapiHostMsg_ESDataSource_SetDuration,
                     PP_TimeDelta /* duration */)
IPC_MESSAGE_CONTROL0(PpapiPluginMsg_ESDataSource_SetDurationReply)
IPC_MESSAGE_CONTROL0(PpapiHostMsg_ESDataSource_SetEndOfStream)
IPC_MESSAGE_CONTROL0(PpapiPluginMsg_ESDataSource_SetEndOfStreamReply)

// MediaPlayer ----------------------------------------------------------------

IPC_MESSAGE_CONTROL1(PpapiHostMsg_MediaPlayer_Create,
                     PP_MediaPlayerMode /* media_player_mode */)
IPC_MESSAGE_CONTROL1(PpapiHostMsg_MediaPlayer_SetMediaEventsListener,
                     bool /* is_set */)
IPC_MESSAGE_CONTROL1(PpapiHostMsg_MediaPlayer_SetSubtitleListener,
                     bool /* is_set */)
IPC_MESSAGE_CONTROL1(PpapiHostMsg_MediaPlayer_SetBufferingListener,
                     bool /* is_set */)
IPC_MESSAGE_CONTROL1(PpapiHostMsg_MediaPlayer_SetDRMListener, bool /* is_set */)
IPC_MESSAGE_CONTROL1(PpapiHostMsg_MediaPlayer_AttachDataSource,
                     PP_Resource /* data_source */)
IPC_MESSAGE_CONTROL0(PpapiHostMsg_MediaPlayer_Play)
IPC_MESSAGE_CONTROL0(PpapiHostMsg_MediaPlayer_Pause)
IPC_MESSAGE_CONTROL0(PpapiHostMsg_MediaPlayer_Stop)
IPC_MESSAGE_CONTROL1(PpapiHostMsg_MediaPlayer_Seek, PP_TimeTicks /* time */)
IPC_MESSAGE_CONTROL1(PpapiHostMsg_MediaPlayer_SetPlaybackRate,
                     double /* rate */)
IPC_MESSAGE_CONTROL0(PpapiHostMsg_MediaPlayer_GetDuration)
IPC_MESSAGE_CONTROL0(PpapiHostMsg_MediaPlayer_GetCurrentTime)
IPC_MESSAGE_CONTROL0(PpapiHostMsg_MediaPlayer_GetPlayerState)
IPC_MESSAGE_CONTROL0(PpapiHostMsg_MediaPlayer_GetCurrentVideoTrackInfo)
IPC_MESSAGE_CONTROL0(PpapiHostMsg_MediaPlayer_GetVideoTracksList)
IPC_MESSAGE_CONTROL0(PpapiHostMsg_MediaPlayer_GetCurrentAudioTrackInfo)
IPC_MESSAGE_CONTROL0(PpapiHostMsg_MediaPlayer_GetAudioTracksList)
IPC_MESSAGE_CONTROL0(PpapiHostMsg_MediaPlayer_GetCurrentTextTrackInfo)
IPC_MESSAGE_CONTROL0(PpapiHostMsg_MediaPlayer_GetTextTracksList)
IPC_MESSAGE_CONTROL2(PpapiHostMsg_MediaPlayer_SelectTrack,
                     PP_ElementaryStream_Type_Samsung /* stream_type */,
                     uint32_t /* track_index */)
IPC_MESSAGE_CONTROL1(PpapiHostMsg_MediaPlayer_SetSubtitlesVisible,
                     bool /* visible */)
IPC_MESSAGE_CONTROL2(PpapiHostMsg_MediaPlayer_AddExternalSubtitles,
                     std::string /* file_path */,
                     std::string /* encoding */)
IPC_MESSAGE_CONTROL1(PpapiHostMsg_MediaPlayer_SetSubtitlesDelay,
                     PP_TimeDelta /* delay */)
...
IPC_MESSAGE_CONTROL3(PpapiHostMsg_MediaPlayer_SetDRMSpecificData,
                     ...
                     std::string /* data */)
IPC_MESSAGE_CONTROL0(PpapiPluginMsg_MediaPlayer_AttachDataSourceReply)
IPC_MESSAGE_CONTROL0(PpapiPluginMsg_MediaPlayer_PlayReply)
IPC_MESSAGE_CONTROL0(PpapiPluginMsg_MediaPlayer_PauseReply)
IPC_MESSAGE_CONTROL0(PpapiPluginMsg_MediaPlayer_StopReply)
IPC_MESSAGE_CONTROL0(PpapiPluginMsg_MediaPlayer_SeekReply)
IPC_MESSAGE_CONTROL0(PpapiPluginMsg_MediaPlayer_SetPlaybackRateReply)
IPC_MESSAGE_CONTROL1(PpapiPluginMsg_MediaPlayer_GetDurationReply,
                     PP_TimeDelta /* duration */)
IPC_MESSAGE_CONTROL1(PpapiPluginMsg_MediaPlayer_GetCurrentTimeReply,
                     PP_TimeTicks /* current_time */)
IPC_MESSAGE_CONTROL1(PpapiPluginMsg_MediaPlayer_GetPlayerStateReply,
                     PP_MediaPlayerState /* state */)
IPC_MESSAGE_CONTROL1(PpapiPluginMsg_MediaPlayer_GetCurrentVideoTrackInfoReply,
                     PP_VideoTrackInfo /* track_info */)
IPC_MESSAGE_CONTROL1(PpapiPluginMsg_MediaPlayer_GetVideoTracksListReply,
                     std::vector<PP_VideoTrackInfo> /* tracks */)
IPC_MESSAGE_CONTROL1(PpapiPluginMsg_MediaPlayer_GetCurrentAudioTrackInfoReply,
                     PP_AudioTrackInfo /* track_info */)
IPC_MESSAGE_CONTROL1(PpapiPluginMsg_MediaPlayer_GetAudioTracksListReply,
                     std::vector<PP_AudioTrackInfo> /* tracks */)
IPC_MESSAGE_CONTROL1(PpapiPluginMsg_MediaPlayer_GetCurrentTextTrackInfoReply,
                     PP_TextTrackInfo /* track_info */)
IPC_MESSAGE_CONTROL1(PpapiPluginMsg_MediaPlayer_GetTextTracksListReply,
                     std::vector<PP_TextTrackInfo> /* tracks */)
IPC_MESSAGE_CONTROL0(PpapiPluginMsg_MediaPlayer_SelectTrackReply)
IPC_MESSAGE_CONTROL0(PpapiPluginMsg_MediaPlayer_SetSubtitlesVisibleReply)
...
IPC_MESSAGE_CONTROL4(PpapiHostMsg_MediaPlayer_OnGeometryChanged,
                     PP_Instance /* instance */,
                     PP_Resource /* resource */,
                     PP_Rect /* plugin_rect */,
                     PP_Rect /* clip_rect */)
...
IPC_MESSAGE_CONTROL1(PpapiHostMsg_URLDataSource_Create,
                     std::string /* file_path */)
IPC_MESSAGE_CONTROL2(PpapiHostMsg_URLDataSource_SetStreamingProperty,
                     PP_StreamingProperty /* type */,
                     std::string /* value */)
IPC_MESSAGE_CONTROL1(PpapiHostMsg_URLDataSource_GetStreamingProperty,
                     PP_StreamingProperty /* type */)
IPC_MESSAGE_CONTROL0(PpapiPluginMsg_URLDataSource_SetStreamingPropertyReply)
IPC_MESSAGE_CONTROL1(PpapiPluginMsg_URLDataSource_GetStreamingPropertyReply,
                     std::string /* value */)

// Media Player---------------------------------------------------------------

// PPPMediaEventsListener messages:
IPC_MESSAGE_CONTROL1(PpapiPluginMsg_MediaEventsListener_OnTimeUpdate,
                     PP_TimeTicks /* time */)
IPC_MESSAGE_CONTROL0(PpapiPluginMsg_MediaEventsListener_OnEnded)
IPC_MESSAGE_CONTROL1(PpapiPluginMsg_MediaEventsListener_OnError,
                     PP_MediaPlayerError /* error */)

// PPPSubtitileListener messages:
IPC_MESSAGE_CONTROL2(PpapiPluginMsg_SubtitleListener_OnShowSubtitle,
                     PP_TimeDelta /* duration */,
                     std::string /* text */)

// PPPBufferingListener messages:
IPC_MESSAGE_CONTROL0(PpapiPluginMsg_BufferingListener_OnBufferingStart)
IPC_MESSAGE_CONTROL1(PpapiPluginMsg_BufferingListener_OnBufferingProgress,
                     uint32_t /* percent */)
IPC_MESSAGE_CONTROL0(PpapiPluginMsg_BufferingListener_OnBufferingComplete)

// PPPDRMListener messages:
IPC_MESSAGE_CONTROL2(PpapiPluginMsg_DRMListener_OnInitDataLoaded,
                     PP_MediaPlayerDRMType /* type */,
                     std::vector<uint8_t> /* init_data */)
IPC_MESSAGE_CONTROL1(PpapiPluginMsg_DRMListener_OnLicenseRequest,
                     std::vector<uint8_t> /* request */)

// PPPElementaryStreamListener messages:
IPC_MESSAGE_CONTROL1(PpapiPluginMsg_ElementaryStreamListener_OnNeedData,
                     int32_t /* max_bytes */)
IPC_MESSAGE_CONTROL0(PpapiPluginMsg_ElementaryStreamListener_OnEnoughData)
IPC_MESSAGE_CONTROL1(PpapiPluginMsg_ElementaryStreamListener_OnSeekData,
...
// TEEC Client
#if defined(TIZEN_PEPPER_TEEC)
IPC_MESSAGE_CONTROL0(PpapiHostMsg_TEECContext_Create)
IPC_MESSAGE_CONTROL1(PpapiHostMsg_TEECContext_Open, std::string /* name */)
IPC_MESSAGE_CONTROL1(PpapiPluginMsg_TEECContext_OpenReply,
                     PP_TEEC_Result /* result */)

IPC_MESSAGE_CONTROL1(PpapiHostMsg_TEECSession_Create, PP_Resource /* context */)
IPC_MESSAGE_CONTROL4(PpapiHostMsg_TEECSession_Open,
                     PP_TEEC_UUID /* destination */,
                     uint32_t /* connection_method */,
                     std::string /* connection_data */,
                     PP_TEEC_Operation /* operation */)
IPC_MESSAGE_CONTROL2(PpapiPluginMsg_TEECSession_OpenReply,
                     PP_TEEC_Result /* result */,
                     PP_TEEC_Operation /* operation */)
IPC_MESSAGE_CONTROL2(PpapiHostMsg_TEECSession_InvokeCommand,
                     uint32_t /* command_id */,
                     PP_TEEC_Operation /* operation */)
IPC_MESSAGE_CONTROL2(PpapiPluginMsg_TEECSession_InvokeCommandReply,
                     PP_TEEC_Result /* result */,
                     PP_TEEC_Operation /* operation */)
IPC_MESSAGE_CONTROL1(PpapiHostMsg_TEECSession_RequestCancellation,
                     PP_TEEC_Operation /* operation */)
IPC_MESSAGE_CONTROL0(PpapiPluginMsg_TEECSession_RequestCancellationReply)

IPC_MESSAGE_CONTROL2(PpapiHostMsg_TEECSharedMemory_Create,
                     PP_Resource /* context */,
                     uint32_t /* flags */)
IPC_MESSAGE_CONTROL1(PpapiHostMsg_TEECSharedMemory_Register,
                     uint32_t /* size */)
IPC_MESSAGE_CONTROL1(PpapiPluginMsg_TEECSharedMemory_RegisterReply,
                     PP_TEEC_Result /* result */)
IPC_MESSAGE_CONTROL1(PpapiHostMsg_TEECSharedMemory_Allocate,
                     uint32_t /* size */)
IPC_MESSAGE_CONTROL1(PpapiPluginMsg_TEECSharedMemory_AllocateReply,
                     PP_TEEC_Result /* result */)
