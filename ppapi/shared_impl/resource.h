...
#define TIZEN_PEPPER_PLAYER_RESOURCE_APIS(F) \
  F(PPB_AudioElementaryStream_API)           \
  F(PPB_ElementaryStream_API)                \
  F(PPB_ESDataSource_API)                    \
  F(PPB_MediaDataSource_API)                 \
  F(PPB_MediaPlayer_API)                     \
  F(PPB_URLDataSource_API)                   \
  F(PPB_VideoElementaryStream_API)
#else
#define TIZEN_PEPPER_PLAYER_RESOURCE_APIS(F)
#endif  // defined(TIZEN_PEPPER_PLAYER)

#if defined(TIZEN_PEPPER_TEEC)
#define TIZEN_PEPPER_TEEC_RESOURCE_APIS(F) \
  F(PPB_TEECContext_API)                   \
  F(PPB_TEECSession_API)                   \
  F(PPB_TEECSharedMemory_API)
#else
#define TIZEN_PEPPER_TEEC_RESOURCE_APIS(F)
...
#define FOR_ALL_PPAPI_RESOURCE_APIS(F)  \
  ...
  TIZEN_PEPPER_PLAYER_RESOURCE_APIS(F)  \
  TIZEN_PEPPER_TEEC_RESOURCE_APIS(F)
