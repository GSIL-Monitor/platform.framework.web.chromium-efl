...
bool ResourceHost::IsMediaPlayerHost() {
  return false;
}

bool ResourceHost::IsMediaPlayerRendererHost() {
  return false;
}

bool ResourceHost::IsMediaDataSourceHost() {
  return false;
}
#endif  // defined(TIZEN_PEPPER_PLAYER)

#if defined(TIZEN_PEPPER_TEEC)
bool ResourceHost::IsTEECContextHost() {
  return false;
}

bool ResourceHost::IsTEECSessionHost() {
  return false;
}

bool ResourceHost::IsTEECSharedMemoryHost() {
  return false;
}
