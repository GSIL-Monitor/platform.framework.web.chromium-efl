...
class PPAPI_HOST_EXPORT ResourceHost : public ResourceMessageHandler {
 public:
  ...
  virtual bool IsMediaPlayerHost();
  virtual bool IsMediaPlayerRendererHost();
  virtual bool IsMediaDataSourceHost();
#endif  // defined(TIZEN_PEPPER_PLAYER)
#if defined(TIZEN_PEPPER_TEEC)
  virtual bool IsTEECContextHost();
  virtual bool IsTEECSessionHost();
  virtual bool IsTEECSharedMemoryHost();
