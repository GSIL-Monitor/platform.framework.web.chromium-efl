...
PP_Bool IsCompositorLayerSamsung(PP_Resource resource) {
  VLOG(4) << "PPB_CompositorLayer::IsCompositorLayerSamsung()";
  EnterResource<PPB_CompositorLayer_API> enter(resource, false);
  return enter.succeeded() ? PP_TRUE : PP_FALSE;
}

int32_t SetBackgroundPlane(PP_Resource layer, const struct PP_Size* size) {
  VLOG(4) << "PPB_CompositorLayer::SetBackgroundPlane()";
  EnterResource<PPB_CompositorLayer_API> enter(layer, true);
  if (enter.failed())
    return enter.retval();
  return enter.object()->SetBackgroundPlane(size);
}
#endif
...
#if defined(TIZEN_PEPPER_EXTENSIONS)
const PPB_CompositorLayer_Samsung_0_1 g_ppb_compositorlayer_samsung_thunk_0_1 =
    {&IsCompositorLayerSamsung, &SetBackgroundPlane};
#endif
...
#if defined(TIZEN_PEPPER_EXTENSIONS)
PPAPI_THUNK_EXPORT const PPB_CompositorLayer_Samsung_0_1*
GetPPB_CompositorLayer_Samsung_0_1_Thunk() {
  return &g_ppb_compositorlayer_samsung_thunk_0_1;
}
#endif
