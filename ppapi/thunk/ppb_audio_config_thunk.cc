...
int32_t SetAudioMode(PP_Resource config_id, PP_AudioMode audio_mode) {
  VLOG(4) << "PPB_AudioConfig_Samsung::SetAudioSoundMode()";
  EnterResource<PPB_AudioConfig_API> enter(config_id, true);
  if (enter.failed())
    return enter.retval();
  return enter.object()->SetAudioMode(audio_mode);
}
#endif
...
#if defined(TIZEN_PEPPER_EXTENSIONS)
const PPB_AudioConfig_Samsung_1_0 g_ppb_audio_config_samsung_thunk_1_0 = {
    &SetAudioMode};
#endif
...
#if defined(TIZEN_PEPPER_EXTENSIONS)
const PPB_AudioConfig_Samsung_1_0* GetPPB_AudioConfig_Samsung_1_0_Thunk() {
  return &g_ppb_audio_config_samsung_thunk_1_0;
}
#endif
