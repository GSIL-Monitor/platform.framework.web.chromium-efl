...
#if defined(TIZEN_PEPPER_PLAYER)
  virtual PP_Resource CreateMediaPlayer(PP_Instance instance,
                                        PP_MediaPlayerMode player_mode,
                                        PP_BindToInstanceMode bind_mode) = 0;
  virtual PP_Resource CreateURLDataSource(PP_Instance instance,
                                          const char* url) = 0;
  virtual PP_Resource CreateESDataSource(PP_Instance instance) = 0;
#endif  // defined(TIZEN_PEPPER_PLAYER)
#if defined(TIZEN_PEPPER_TEEC)
  virtual PP_Resource CreateTEECContext(PP_Instance instance) = 0;
  virtual PP_Resource CreateTEECSession(PP_Instance instance,
                                        PP_Resource context) = 0;
  virtual PP_Resource CreateTEECSharedMemory(PP_Instance instance,
                                             PP_Resource context,
                                             uint32_t flags) = 0;
