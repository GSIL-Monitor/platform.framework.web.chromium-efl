...
/* From samsung/ppb_testing_samsung.idl modified Mon Sep 19 15:21:41 2016. */

#ifndef PPAPI_C_SAMSUNG_PPB_TESTING_SAMSUNG_H_
#define PPAPI_C_SAMSUNG_PPB_TESTING_SAMSUNG_H_
...
#define PPB_TESTING_SAMSUNG_INTERFACE_1_0 "PPB_Testing_Samsung;1.0"
#define PPB_TESTING_SAMSUNG_INTERFACE PPB_TESTING_SAMSUNG_INTERFACE_1_0

/**
 * @file
 * This file contains interface functions used for unit testing.
 */
 ...
 * @{
 */
struct PPB_Testing_Samsung_1_0 {
  /**
  ...
  /**
   * Simulate losing graphics 3D context.
   */
  void (*LoseContext)(PP_Instance instance);
};

typedef struct PPB_Testing_Samsung_1_0 PPB_Testing_Samsung;
/**
 * @}
 */

#endif  /* PPAPI_C_SAMSUNG_PPB_TESTING_SAMSUNG_H_ */
