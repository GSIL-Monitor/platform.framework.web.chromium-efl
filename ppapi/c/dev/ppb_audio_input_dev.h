...
/* From dev/ppb_audio_input_dev.idl modified Thu Jan 11 12:54:47 2018. */
...
struct PPB_AudioInput_Dev_0_4 {
   ...
   * @param[in] audio_input A <code>PP_Resource</code> corresponding to an audio
   * input resource.
   * @param[in] device_ref Identifies an audio input device. It must be one of
   * the resource in the array returned by EnumerateDevices(). There is no
   * default device.
